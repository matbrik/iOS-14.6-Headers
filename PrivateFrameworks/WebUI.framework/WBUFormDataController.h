...
- (bool)_saveUser:(id)arg1 password:(id)arg2 isGeneratedPassword:(bool)arg3 forURL:(id)arg4 formType:(unsigned long long)arg5 promptingPolicy:(long long)arg6 webView:(id)arg7 completionHandler:(id /* block */)arg8;
...
- (bool)_webView:(id)arg1 formSubmission:(bool)arg2 willSubmitNewAccountOrChangePasswordFormWithMetadata:(id)arg3 shouldPreferAnnotatedCredentials:(bool)arg4 fromFrame:(id)arg5 submissionHandler:(id /* block */)arg6;
...
- (bool)_webView:(id)arg1 saveUsernameAndPasswordForURL:(id)arg2 formType:(unsigned long long)arg3 inFrame:(id)arg4 username:(id)arg5 password:(id)arg6 isGeneratedPassword:(bool)arg7 confirmOverwritingCurrentPassword:(bool)arg8 submissionHandler:(id /* block */)arg9;
- (bool)_webView:(id)arg1 saveUsernameAndPasswordFromForm:(id)arg2 inFrame:(id)arg3 confirmOverwritingCurrentPassword:(bool)arg4 shouldPreferAnnotatedCredentials:(bool)arg5 submissionHandler:(id /* block */)arg6;
