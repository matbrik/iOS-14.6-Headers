...
- (void)canUpdateDataPrivacyStatusWithCompletion:(id /* block */)arg1;
- (id)cdpContext;
- (void)dataPrivacyStatusWithCompletion:(id /* block */)arg1;
...
- (void)recoveryKeyAvailabilityWithCompletion:(id /* block */)arg1;
- (void)setCdpContext:(id)arg1;
- (void)setDataPrivacyEnabled:(bool)arg1 completion:(id /* block */)arg2;
