...
- (void)_updatePlayerRate:(float)arg1 rateChangeReason:(int)arg2 rateChangeIdentifier:(id)arg3 figPlayerSetRateHandler:(id /* block */)arg4;
...
- (bool)interstitialPlaybackAllowed;
