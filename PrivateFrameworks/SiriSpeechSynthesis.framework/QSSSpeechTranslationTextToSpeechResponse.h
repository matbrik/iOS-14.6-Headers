...
@interface QSSSpeechTranslationTextToSpeechResponse : NSObject <FLTBFBufferAccessor, NSCopying> {
    NSData * _data;
    const struct SpeechTranslationTextToSpeechResponse { unsigned char x1[1]; } * _root;
