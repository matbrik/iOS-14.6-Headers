...
@interface FTSpeechTranslationFinalRecognitionResponse : NSObject <FLTBFBufferAccessor, NSCopying> {
    NSData * _data;
    const struct SpeechTranslationFinalRecognitionResponse { unsigned char x1[1]; } * _root;
