...
+ (id)presentUnsubscribeAlertWithOptions:(unsigned long long)arg1 viewController:(id)arg2 sourceView:(id)arg3 sourceRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg4 forEvent:(id)arg5 withCompletionHandler:(id /* block */)arg6;
+ (id)unsubscribeAlertWithOptions:(unsigned long long)arg1 forEvent:(id)arg2 withCompletionHandler:(id /* block */)arg3;
