...
@property (nonatomic) bool hasMultiTagState;
...
@property (nonatomic) unsigned int multiTagState;
...
- (void).cxx_destruct;
- (unsigned int)accessUniversityCode;
- (id)aid;
...
- (unsigned int)endEventInterface;
...
- (unsigned int)issuerCityCode;
- (unsigned int)localValidation;
- (unsigned int)maxRSSIValue;
- (void)mergeFrom:(id)arg1;
- (unsigned int)minRSSIValue;
- (unsigned int)multiTagState;
- (bool)readFrom:(id)arg1;
- (void)setAccessUniversityCode:(unsigned int)arg1;
- (void)setAid:(id)arg1;
...
- (void)setEndEventInterface:(unsigned int)arg1;
...
- (void)setHasMultiTagState:(bool)arg1;
...
- (void)setIssuerCityCode:(unsigned int)arg1;
- (void)setLocalValidation:(unsigned int)arg1;
- (void)setMaxRSSIValue:(unsigned int)arg1;
- (void)setMinRSSIValue:(unsigned int)arg1;
- (void)setMultiTagState:(unsigned int)arg1;
- (void)setSfiRead:(unsigned int)arg1;
- (void)setSfiUpdated:(unsigned int)arg1;
...
- (unsigned int)sfiRead;
- (unsigned int)sfiUpdated;
- (unsigned int)spid;
- (id)stationID;
