...
@interface _ANEDeviceController : NSObject {
    struct ANEDeviceStruct { void *x1; void *x2; void *x3; } * _device;
    bool  _isPrivileged;
...
@property (nonatomic) struct ANEDeviceStruct { void *x1; void *x2; void *x3; }*device;
...
- (void).cxx_destruct;
- (struct ANEDeviceStruct { void *x1; void *x2; void *x3; }*)device;
- (id)initWithProgramHandle:(unsigned long long)arg1 priviledged:(bool)arg2;
- (bool)isPrivileged;
- (unsigned long long)programHandle;
- (id)q;
- (void)setDevice:(struct ANEDeviceStruct { void *x1; void *x2; void *x3; }*)arg1;
