...
@interface AUPasscodeDecoder : AUAudioUnit {
    ...
    struct unique_ptr<CADeprecated::RealtimeMessenger, std::__1::default_delete<CADeprecated::RealtimeMessenger>> { 
        struct __compressed_pair<CADeprecated::RealtimeMessenger *, std::__1::default_delete<CADeprecated::RealtimeMessenger>> { 
