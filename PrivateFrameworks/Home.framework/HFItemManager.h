...
@interface HFItemManager : NSObject <HFAccessoryObserver, HFAudioControlObserver, HFCameraObserver, HFHomeKitSettingsObserver, HFHomeManagerObserver, HFHomeObserver, HFItemUpdating, HFLightObserver, HFMediaDestinationControllerObserver, HFMediaObjectObserver, HFMediaSessionObserver, HFNetworkConfigurationObserver, HFNetworkRouterObserver, HFPersonManagerObserver, HFResidentDeviceObserver, HFSoftwareUpdateControllerObserver, HFSoftwareUpdateObserver, HFStateDumpBuildable, HFSymptomFixSessionObserver, HFSymptomsHandlerObserver, HFTelevisionObserver, HFTemperatureUnitObserver, HFUserObserver> {
