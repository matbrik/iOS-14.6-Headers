...
@property (nonatomic, retain) UIColor *defaultNameTextColor;
...
@property (nonatomic, retain) HUVisualEffectContainerView *firmwareUpdateView;
...
- (void)setDefaultNameTextColor:(id)arg1;
...
- (void)setFirmwareUpdateView:(id)arg1;
