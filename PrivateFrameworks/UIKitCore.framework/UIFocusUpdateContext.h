...
@interface UIFocusUpdateContext : NSObject {
    ...
    _UIFocusGroup * _nextFocusedGroup;
    _UIDebugLogReport * _preferredFocusReport;
    _UIFocusGroup * _previouslyFocusedGroup;
...
@property (getter=_nextFocusedGroup, nonatomic, readonly) _UIFocusGroup *nextFocusedGroup;
...
@property (getter=_previouslyFocusedGroup, nonatomic, readonly) _UIFocusGroup *previouslyFocusedGroup;
...
- (id)_nextFocusedGroup;
- (id)_preferredFocusReport;
- (id)_previouslyFocusedGroup;
