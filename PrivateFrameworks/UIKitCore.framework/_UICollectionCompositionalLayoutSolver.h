...
- (void)_injectPreferredSizingDataIntoToLayoutAttributes:(id)arg1 atIndexPath:(id)arg2;
...
- (id)options;
- (struct CGPoint { double x1; double x2; })orthogonalContentOffsetForProposedContentOffset:(struct CGPoint { double x1; double x2; })arg1 section:(long long)arg2 item:(long long)arg3;
