...
- (struct opaqueCMSession { }*)createSecureMicrophoneFacetimeAudioSession;
...
- (int)setAndVerifyPropertyForMXSession:(int)arg1 propertyName:(struct __CFString { }*)arg2 andValue:(void*)arg3 sessionToSet:(void*)arg4;
