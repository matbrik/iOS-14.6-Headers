...
@interface HDFeatureAvailabilityManager : NSObject <HDFeatureAvailabilityExtension, HDOnboardingCompletionManagerObserver, HDPairedDeviceCapabilityProvidingDelegate, HDRemoteFeatureAvailabilityProvidingDelegate> {
...
- (void).cxx_destruct;
- (bool)_isRegionAllowedWithCountryCode:(id)arg1;
- (id)_onboardedCountryCodeSupportedStateWithRemoteDisabledEvaluator:(id /* block */)arg1 error:(id*)arg2;
