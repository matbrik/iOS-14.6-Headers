...
@interface HMHome : NSObject <HFCharacteristicValueReader, HFCharacteristicValueWriter, HFHomeKitObject, HFReorderableHomeKitObject, HFStateDumpBuildable, HFWallaperHost, HMFLogging, HMFMessageReceiver, HMMutableApplicationData, HMObjectMerge, HMUserActionPredictionControllerDataSource, NSSecureCoding, _COHomeKitNamedEntity> {
    bool  _adminUser;
...
- (void)startPairingWithAccessoryDescription:(id)arg1 progressHandler:(id /* block */)arg2 completionHandler:(id /* block */)arg3;
...
- (id)an_accessoryWithUniqueIdentifierUUIDString:(id)arg1;
