...
@property /* Warning: unhandled struct encoding: '{SourceBufferParserAVFObjC=^^?{atomic<unsigned int>={__cxx_atomic_impl<unsigned int' */ struct *parent; /* unknown property attribute:  WTF::DefaultRefDerefTraits<const WTF::Logger>>=^{Logger}}^v} */
