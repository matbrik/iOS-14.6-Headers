...
@property (readonly) struct InjectedBundleNodeHandle { int (**x1)(); id x2; int (**x3)(); struct ScriptExecutionContext {} *x4; unsigned int x5; /* Warning: unhandled struct encoding: '{RefPtr<WebCore::Node' */ struct x6; }*_nodeHandle; /* unknown property attribute:  WTF::DefaultRefDerefTraits<WebCore::Node>>=^{Node}}} */
...
- (struct InjectedBundleNodeHandle { int (**x1)(); id x2; int (**x3)(); struct ScriptExecutionContext {} *x4; unsigned int x5; struct RefPtr<WebCore::Node, WTF::RawPtrTraits<WebCore::Node>, WTF::DefaultRefDerefTraits<WebCore::Node>> { struct Node {} *x_6_1_1; } x6; }*)_nodeHandle;
- (void)dealloc;
