...
@interface CKVField : NSObject <FLTBFBufferAccessor, NSCopying> {
    NSData * _data;
    const struct Field { unsigned char x1[1]; } * _root;
...
- (id)initWithFlatbuffData:(id)arg1 root:(const struct Field { unsigned char x1[1]; }*)arg2;
- (id)initWithFlatbuffData:(id)arg1 root:(const struct Field { unsigned char x1[1]; }*)arg2 verify:(bool)arg3;
- (id)label;
- (id)value;
