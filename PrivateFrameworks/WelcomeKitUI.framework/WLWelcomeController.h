...
- (void)_didCompleteMigrationWithSuccess:(bool)arg1 retry:(bool)arg2 skippedPhotos:(unsigned long long)arg3 skippedVideos:(unsigned long long)arg4;
...
- (void)_showCompleted:(unsigned long long)arg1 skippedVideos:(unsigned long long)arg2;
...
- (void)dataMigratorDidFinish:(id)arg1 withImportErrors:(bool)arg2 skippedPhotos:(unsigned long long)arg3 skippedVideos:(unsigned long long)arg4;
