...
@interface CKExpandedAppViewController : UIViewController <CKAppGrabberViewDelegate, CKBrowserViewControllerProtocol, CKExpandedAppViewControllerProtocol, CKFullScreenAppNavbarManagerDelegate, UIGestureRecognizerDelegate> {
