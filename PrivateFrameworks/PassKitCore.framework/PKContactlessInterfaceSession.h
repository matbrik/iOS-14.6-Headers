...
@interface PKContactlessInterfaceSession : PKPaymentSession <NFDigitalCarKeySessionDelegate, NFLoyaltyAndPaymentSessionDelegate> {
    ...
    bool  _isDigitialCarKeySession;
    bool  _isLoyaltyPaymentSession;
