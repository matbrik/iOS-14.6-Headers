...
@property (nonatomic) long long previousElectrocardiogramRescindedStatusCache;
...
- (long long)previousElectrocardiogramRescindedStatusCache;
- (id)profile;
...
- (void)setPreviousElectrocardiogramRescindedStatusCache:(long long)arg1;
