...
- (void)updateActivityZones:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)updateNightVisionModeEnabled:(bool)arg1 completionHandler:(id /* block */)arg2;
- (void)updateReachabilityChangeNotificationEnabled:(bool)arg1 completionHandler:(id /* block */)arg2;
