...
- (int)_doStartRecordingAtTime:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg1 withSettings:(id)arg2 sensorVideoPort:(struct __CFString { }*)arg3;
...
- (struct { long long x1; int x2; unsigned int x3; long long x4; })_findStartMarkersWithMatchedStagedSetting:(id*)arg1 sensorVideoPort:(const struct __CFString {}**)arg2;
...
- (void)_generateThumbnailSurfaceFromPixelBuffer:(struct __CVBuffer { }*)arg1 physicallyMirroredHorizontallyUpstream:(bool)arg2;
