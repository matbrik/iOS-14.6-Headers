...
@property (nonatomic, readonly) TTOrderedSetVersionedDocument *activityEventsDocument;
...
@property (nonatomic, readonly) ICMergableDictionary *replicaIDToNotesVersion;
