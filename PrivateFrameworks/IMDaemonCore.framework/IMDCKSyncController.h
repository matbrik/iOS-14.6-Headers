...
- (void)_handleSyncFailure:(long long)arg1 stage:(id)arg2 error:(id)arg3 activity:(id)arg4 attemptCount:(unsigned long long)arg5 deviceConditionsToCheck:(unsigned long long)arg6 completion:(id /* block */)arg7;
