...
@interface HUDashboardViewController : HUControllableItemCollectionViewController <HFAccessoryObserver, HFHomeManagerObserver, HFHomeObserver, HFMediaServiceManagerObserver, HFUserObserver, HUBannerCellDelegate, HUDashboardItemManagerDelegate, HUDashboardMenuNavigationActionDelegate, HUDashboardScrollingAnimationControllerDelegate, HUGridEmptyHomeViewDelegate, HUHomeKitObjectPresenting, HUPresentationDelegate, HUPrototypeLayoutOptionsEditorViewControllerDelegate, HUSoftwareUpdateUIPresentationDelegate, UIDropInteractionDelegate, UIViewControllerTransitioningDelegate> {
