...
- (void)_queue_statusForReceivedInvitation:(id)arg1 completion:(id /* block */)arg2;
- (void)_queue_statusForSentInvitation:(id)arg1 completion:(id /* block */)arg2;
...
- (void)statusForReceivedInvitation:(id)arg1 completion:(id /* block */)arg2;
- (void)statusForSentInvitation:(id)arg1 completion:(id /* block */)arg2;
