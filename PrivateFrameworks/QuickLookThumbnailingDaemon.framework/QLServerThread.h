...
- (void)addImageData:(id)arg1 withBitmapFormat:(id)arg2 contentRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg3 hasIconModeApplied:(bool)arg4 flavor:(int)arg5 metadata:(id)arg6 toCacheAndCompleteRequest:(id)arg7;
- (id)cacheThread;
...
- (id)currentFetchThumbnailsOperations;
...
- (void)findThumbnailInAddition:(id)arg1 request:(id)arg2 url:(id)arg3 completionHandler:(id /* block */)arg4;
- (void)findUncachedThumbnailForFileThumbnailRequest:(id)arg1;
- (void)findUncachedThumbnailForFileThumbnailRequest:(id)arg1 taggedLogicalPromisedURL:(id)arg2 completionHandler:(id /* block */)arg3;
- (void)findUncachedThumbnailForFileThumbnailRequest:(id)arg1 taggedLogicalURL:(id)arg2 completionHandler:(id /* block */)arg3;
- (void)findUncachedThumbnailForThumbnailRequest:(id)arg1 downloadedFileAtTaggedLogicalURL:(id)arg2 completionHandler:(id /* block */)arg3;
- (void)findUncachedThumbnailForThumbnailRequest:(id)arg1 downloadedItem:(id)arg2 atTaggedLogicalURL:(id)arg3 completionHandler:(id /* block */)arg4;
...
- (void)findUncachedThumbnailInGenStoreAndExternalThumbnailCacheForRequest:(id)arg1 item:(id)arg2 URL:(id)arg3 completionHandler:(id /* block */)arg4;
...
- (void)generateThumbnailForThumbnailRequest:(id)arg1 item:(id)arg2 atTaggedLogicalURL:(id)arg3 shouldUpdateGenstore:(bool)arg4 completionHandler:(id /* block */)arg5;
...
- (void)processLargeThumbnailData:(id)arg1 withContentType:(id)arg2 precacheThumbnails:(bool)arg3 forRequest:(id)arg4 url:(id)arg5 completionHandler:(id /* block */)arg6;
...
- (void)setCurrentFetchThumbnailsOperations:(id)arg1;
