...
- (bool)doScheduleParamCurveWithMemoryReserve:(unsigned long long)arg1 atTime:(double)arg2 channel:(unsigned long long)arg3 memoryReserve:(struct AddressReserve { void *x1; unsigned int x2; void *x3; unsigned int x4; int x5; }*)arg4 paramCurve:(id)arg5 error:(id*)arg6;
...
- (int)setupSharedMemory:(struct object { id x1; })arg1 size:(unsigned int)arg2;
