...
@interface PKPassPaymentContainerView : PKPassFooterContentView <PKAuthenticatorDelegate, PKContactlessInterfaceSessionDelegate, PKForegroundActiveArbiterObserver, PKLinkedApplicationObserver, PKPassPaymentApplicationViewDelegate, PKPassPaymentPayStateViewDelegate, PKPaymentServiceDelegate, PKTransactionAuthenticationPasscodeViewControllerDelegate, PKUIForegroundActiveArbiterDeactivationObserver, UITextViewDelegate> {
