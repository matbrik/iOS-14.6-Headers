...
@property (nonatomic) /* Warning: unhandled struct encoding: '{_KDBoundingBox={vector<_KDInterval' */ struct  boundingBox; /* unknown property attribute:  std::__1::allocator<_KDInterval>>=^{_KDInterval}}}Q} */
...
- (struct _KDBoundingBox { struct vector<_KDInterval, std::__1::allocator<_KDInterval>> { struct _KDInterval {} *x_1_1_1; struct _KDInterval {} *x_1_1_2; struct __compressed_pair<_KDInterval *, std::__1::allocator<_KDInterval>> { struct _KDInterval {} *x_3_2_1; } x_1_1_3; } x1; unsigned long long x2; })boundingBox;
...
- (void)print;
- (id)rightChild;
- (void)setBoundingBox:(struct _KDBoundingBox { struct vector<_KDInterval, std::__1::allocator<_KDInterval>> { struct _KDInterval {} *x_1_1_1; struct _KDInterval {} *x_1_1_2; struct __compressed_pair<_KDInterval *, std::__1::allocator<_KDInterval>> { struct _KDInterval {} *x_3_2_1; } x_1_1_3; } x1; unsigned long long x2; })arg1;
