...
@interface PKPaletteViewInteraction : NSObject <PKPaletteHostingWindowScene, PKPaletteTapToRadarCommandDelegate, UIEditingOverlayInteractionWithView, UIInputResponderControllerVisibilityObserver, UIInteraction, _UISceneComponentProviding> {
...
@property (nonatomic) <PKPaletteViewDelegate> *paletteViewDelegate;
...
- (void)setPaletteViewDelegate:(id)arg1;
