...
@interface UISearchBar : UIView <HUSearchBar, UIBarPositioning, UIScribbleInteractionDelegate, UITextInputTraits, UITextInputTraits_Private, _UIBarPositioningInternal, _UINavigationBarAugmentedTitleView, _UISearchBarVisualProvidingDelegate> {
    ...
    <_UISearchBarVisualProviding> * _visualProvider;
}
...
@property (nonatomic, readonly) <_UISearchBarVisualProviding> *_visualProvider;
...
- (void)_replaceTextInRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1 withToken:(id)arg2;
