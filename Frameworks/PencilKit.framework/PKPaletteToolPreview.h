...
@interface PKPaletteToolPreview : UIView <PKEdgeLocatable, PKPaletteColorPickerControllerDelegate, PKPalettePopoverDismissing, PKPaletteViewSizeScaling, UIPopoverPresentationControllerDelegate> {
