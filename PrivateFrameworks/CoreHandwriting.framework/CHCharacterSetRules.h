...
@property (nonatomic, retain) NSCharacterSet *containsTwoDotsCharSet;
@property (nonatomic, retain) NSCharacterSet *currencySymbols;
...
@property (nonatomic, retain) NSCharacterSet *endOfSentencePunctuationCharSet;
@property (nonatomic, retain) NSCharacterSet *endOfWordPunctuationCharSet;
...
@property (nonatomic, retain) NSCharacterSet *nonSpaceSeparatorCharSet;
...
@property (nonatomic, retain) NSCharacterSet *punctuationThatNeedSpaceCleanup;
@property (nonatomic, retain) NSCharacterSet *selfLoopPunctuationCharSet;
@property (nonatomic, retain) NSCharacterSet *sentenceStartPunctuationInSpanish;
...
@property (nonatomic, retain) NSCharacterSet *symbolsRequiringSpaceBeforeInFrench;
...
- (void)setContainsTwoDotsCharSet:(id)arg1;
...
- (void)setSymbolsRequiringSpaceBeforeInFrench:(id)arg1;
