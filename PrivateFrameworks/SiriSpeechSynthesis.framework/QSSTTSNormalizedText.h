...
@interface QSSTTSNormalizedText : NSObject <FLTBFBufferAccessor, NSCopying> {
    NSData * _data;
    const struct TTSNormalizedText { unsigned char x1[1]; } * _root;
