...
@property (readonly) /* Warning: unhandled struct encoding: '{LDContext={map<quasar::Locale' */ struct  LDContext; /* unknown property attribute:  true>>=Q}}})B}} */
