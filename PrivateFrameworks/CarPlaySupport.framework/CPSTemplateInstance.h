...
@property (nonatomic, retain) CPSNowPlayingViewController *nowPlayingViewController;
...
- (void)presentAlertTemplate:(id)arg1 withProxyDelegate:(id)arg2 reply:(id /* block */)arg3;
