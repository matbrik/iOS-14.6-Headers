...
- (id)dummyLayer;
- (void)executeForwardToLayerIndex:(unsigned long long)arg1 resultTensor:(id)arg2 resultStateIsTemporary:(bool)arg3 batchSize:(unsigned long long)arg4 forTraining:(bool)arg5 enableProfiling:(bool)arg6;
...
- (void)executeGradientFromLayerIndex:(unsigned long long)arg1 resultStateIsTemporary:(bool)arg2 batchSize:(unsigned long long)arg3 enableProfiling:(bool)arg4;
...
- (void)executeOptimizerUpdateWithEnableProfiling:(bool)arg1;
...
- (bool)shareSourceAndResultGradientTensorDeviceMemoryForLayer:(id)arg1 sourceTensor:(id)arg2 resultGradientTensor:(id)arg3;
