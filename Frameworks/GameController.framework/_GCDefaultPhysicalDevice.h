...
@interface _GCDefaultPhysicalDevice : NSObject <GCAdaptiveTriggersServiceClientInterface, GCBatteryServiceClientInterface, _GCDeviceAdaptiveTriggersComponent, _GCDeviceBatteryComponent, _GCDeviceGamepadComponent, _GCDeviceHapticCapabilitiesComponent, _GCDeviceLightComponent, _GCDeviceMotionComponent, _GCDevicePlayerIndexIndicatorComponent, _GCPhysicalDevice> {
