...
@interface NUIContainerView : UIView {
    ...
    /* Warning: unhandled struct encoding: '{vector<CALayer *, std::__1::allocator<CALayer *>>="__begin_"^@"__end_"^@"__end_cap_"{__compressed_pair<CALayer **, std::__1::allocator<CALayer *>>="__value_"^@}}' */ struct vector<CALayer *, std::__1::allocator<CALayer *>> { 
        __end_ **__begin_; 
