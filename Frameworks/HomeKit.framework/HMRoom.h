...
@interface HMRoom : NSObject <HFHomeKitObject, HFReorderableHomeKitObject, HFStateDumpBuildable, HFWallaperHost, HMMutableApplicationData, HMObjectMerge, NSSecureCoding, _COHomeKitNamedEntity> {
