...
@property (nonatomic, readonly, copy) NSString *curatorHandle;
...
@property (nonatomic, readonly, copy) NSDictionary *importableStorePlatformDictionary;
...
@property (getter=isMasteredForiTunes, nonatomic, readonly) bool masteredForiTunes;
...
@property (nonatomic, readonly, copy) NSString *personalMixSortKey;
...
@property (nonatomic, readonly, copy) NSArray *radioStationEvents;
@property (nonatomic, readonly, copy) NSString *radioStationProviderName;
@property (nonatomic, readonly, copy) NSString *radioStationSubtype;
...
@property (nonatomic, readonly, copy) NSString *shortDescriptionText;
