...
@property (nonatomic, readonly) NSString *conversationListCollectionViewListItemIdentifier;
@property (nonatomic, readonly) NSString *conversationListCollectionViewPinnedItemIdentifier;
...
@property (nonatomic, readonly) int wasDetectedAsSMSCategory;
