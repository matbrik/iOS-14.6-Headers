...
@property (nonatomic) <TTTextStorageDelegate> *delegate;
...
@property (nonatomic) long long ignoreTimestampUpdatesCount;
...
@property (nonatomic, readonly) bool isIgnoringTimestampUpdates;
...
- (bool)isIgnoringTimestampUpdates;
