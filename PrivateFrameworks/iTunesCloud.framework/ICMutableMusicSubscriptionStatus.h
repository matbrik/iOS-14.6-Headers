...
@property (getter=isBundleOnwer, nonatomic) bool bundleOwner;
...
@property (getter=isPartOfBundle, nonatomic) bool partOfBundle;
...
- (void)setPartOfBundle:(bool)arg1;
