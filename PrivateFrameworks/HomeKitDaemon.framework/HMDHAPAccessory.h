...
@interface HMDHAPAccessory : HMDAccessory <HAPAccessoryServerNotification, HAPRelayAccessoryDelegate, HMDAccessoryIdentify, HMDAccessoryMinimumUserPrivilegeCapable, HMDAccessoryUserManagement, HMDServiceOwner, HMFTimerDelegate> {
...
- (id)_filterEventModificationForCharacteristics:(id)arg1 enableNotification:(bool)arg2 clientIdentifier:(id)arg3;
