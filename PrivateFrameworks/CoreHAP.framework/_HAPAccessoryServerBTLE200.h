...
@property (nonatomic, retain) NSError *pairingDisconnectionError;
...
- (void)_readPendingCharacteritiscTypes:(id)arg1 completion:(id /* block */)arg2;
...
- (void)disconnectWithCompletionHandler:(id /* block */)arg1 disconnectionError:(id)arg2;
...
- (bool)removePairingForCurrentControllerOnQueue:(id)arg1 completion:(id /* block */)arg2 serverPairingCompletion:(id /* block */)arg3;
...
- (void)setPairingDisconnectionError:(id)arg1;
