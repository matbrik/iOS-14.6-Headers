...
- (id)_initWithSourceApplication:(id)arg1 processHandle:(id)arg2 annotation:(id)arg3 openInPlace:(bool)arg4 eventAttribution:(id)arg5 openAsDownload:(bool)arg6;
- (bool)_openAsDownload;
