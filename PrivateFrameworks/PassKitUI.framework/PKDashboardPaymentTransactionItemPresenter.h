...
- (void)viewControllerForTransaction:(id)arg1 transactionSourceCollection:(id)arg2 familyCollection:(id)arg3 account:(id)arg4 accountUserCollection:(id)arg5 forcePreventHistory:(bool)arg6 completion:(id /* block */)arg7;
