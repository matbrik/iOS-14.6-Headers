...
@property (nonatomic, retain) NSDictionary *_resolvedMIITDictionary;
...
@property (nonatomic, readonly, copy) NSDictionary *miitDictionary;
...
- (void)set_resolvedMIITDictionary:(id)arg1;
