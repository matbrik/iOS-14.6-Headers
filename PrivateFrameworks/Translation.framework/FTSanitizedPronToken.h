...
@interface FTSanitizedPronToken : NSObject <FLTBFBufferAccessor, NSCopying> {
    NSData * _data;
    const struct SanitizedPronToken { unsigned char x1[1]; } * _root;
