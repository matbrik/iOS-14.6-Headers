...
@interface MKPlaceCollectionsLogicController : NSObject <CollectionsAnalyticsProvider, MKCollectionDataProvider, MKCollectionUpdater, MKCollectionsFetcher, MKPlaceBatchGuideConsumer> {
