...
@interface FCConfigurationManager : NSObject <FCCoreConfigurationManager, FCFeldsparIDProviderObserving, FCMagazinesConfigurationManager, FCNewsAppConfigurationManager, FCTodayFeedConfigurationManager> {
...
- (void)fetchTodayFeedConfigurationIfNeededWithCompletionQueue:(id)arg1 feedType:(unsigned long long)arg2 completion:(id /* block */)arg3;
