...
- (void).cxx_destruct;
- (id)initWithGraph:(id)arg1 inputTensors:(id)arg2 controlDependencies:(id)arg3 size:(id)arg4 mode:(unsigned long long)arg5 centerResult:(bool)arg6 alignCorners:(bool)arg7 layout:(unsigned long long)arg8 name:(id)arg9 context:(struct MLIRContext { struct unique_ptr<mlir::MLIRContextImpl, std::__1::default_delete<mlir::MLIRContextImpl>> { struct __compressed_pair<mlir::MLIRContextImpl *, std::__1::default_delete<mlir::MLIRContextImpl>> { struct MLIRContextImpl {} *x_1_2_1; } x_1_1_1; } x1; }*)arg10;
