...
@property (nonatomic, readonly) NSArray *userIdentifiers;
...
- (id)an_compactMap:(id /* block */)arg1;
- (id)an_filter:(id /* block */)arg1;
- (id)an_firstWhere:(id /* block */)arg1;
- (id)an_flatMap:(id /* block */)arg1;
- (id)an_map:(id /* block */)arg1;
- (id)contexts;
...
- (id)sh_sliceIntoChunksOfMaximumSize:(long long)arg1;
...
- (id)tsch_initTSCHChartGridValuesWithProtobufGridRow:(const struct GridRow { int (**x1)(); struct InternalMetadata { void *x_2_1_1; } x2; struct RepeatedPtrField<TSCH::GridValue> { struct Arena {} *x_3_1_1; int x_3_1_2; int x_3_1_3; struct Rep {} *x_3_1_4; } x3; struct CachedSize { struct atomic<int> { struct __cxx_atomic_impl<int, std::__1::__cxx_atomic_base_impl<int>> { _Atomic int x_1_3_1; } x_1_2_1; } x_4_1_1; } x4; }*)arg1;
...
- (id)tsch_initWithSwapTuples:(const struct StyleSwapUndoTuplesArchive { int (**x1)(); struct InternalMetadata { void *x_2_1_1; } x2; struct RepeatedPtrField<TSCH::StyleSwapUndoTupleArchive> { struct Arena {} *x_3_1_1; int x_3_1_2; int x_3_1_3; struct Rep {} *x_3_1_4; } x3; struct CachedSize { struct atomic<int> { struct __cxx_atomic_impl<int, std::__1::__cxx_atomic_base_impl<int>> { _Atomic int x_1_3_1; } x_1_2_1; } x_4_1_1; } x4; }*)arg1 unarchiver:(id)arg2;
...
- (void)tsch_saveTSCHChartGridValuesToProtobufGridRow:(struct GridRow { int (**x1)(); struct InternalMetadata { void *x_2_1_1; } x2; struct RepeatedPtrField<TSCH::GridValue> { struct Arena {} *x_3_1_1; int x_3_1_2; int x_3_1_3; struct Rep {} *x_3_1_4; } x3; struct CachedSize { struct atomic<int> { struct __cxx_atomic_impl<int, std::__1::__cxx_atomic_base_impl<int>> { _Atomic int x_1_3_1; } x_1_2_1; } x_4_1_1; } x4; }*)arg1;
...
- (void)tsch_saveToSwapTuples:(struct StyleSwapUndoTuplesArchive { int (**x1)(); struct InternalMetadata { void *x_2_1_1; } x2; struct RepeatedPtrField<TSCH::StyleSwapUndoTupleArchive> { struct Arena {} *x_3_1_1; int x_3_1_2; int x_3_1_3; struct Rep {} *x_3_1_4; } x3; struct CachedSize { struct atomic<int> { struct __cxx_atomic_impl<int, std::__1::__cxx_atomic_base_impl<int>> { _Atomic int x_1_3_1; } x_1_2_1; } x_4_1_1; } x4; }*)arg1 archiver:(id)arg2;
...
- (id)tsp_initWithProtobufStringArray:(const struct RepeatedPtrField<std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>> { struct Arena {} *x1; int x2; int x3; struct Rep {} *x4; }*)arg1;
- (id)tsp_initWithProtobufUUIDArray:(const struct RepeatedPtrField<TSP::UUID> { struct Arena {} *x1; int x2; int x3; struct Rep {} *x4; }*)arg1;
- (id)tsp_initWithUInt32Array:(const struct RepeatedField<unsigned int> { int x1; int x2; void *x3; }*)arg1;
...
- (void)tsp_saveToProtobufStringArray:(struct RepeatedPtrField<std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>> { struct Arena {} *x1; int x2; int x3; struct Rep {} *x4; }*)arg1;
- (void)tsp_saveToProtobufUUIDArray:(struct RepeatedPtrField<TSP::UUID> { struct Arena {} *x1; int x2; int x3; struct Rep {} *x4; }*)arg1;
- (void)tsp_saveToUInt32Array:(struct RepeatedField<unsigned int> { int x1; int x2; void *x3; }*)arg1;
