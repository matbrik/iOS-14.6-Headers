...
- (bool)isPrimaryConnectionImprovedFromHistory:(struct ConnectionStatsHistory { unsigned char x1; unsigned char x2[5]; unsigned char x3[2][5]; unsigned char x4[2][5]; }*)arg1 withIndex:(int)arg2 remoteStatsHistory:(struct ConnectionStatsHistory { unsigned char x1; unsigned char x2[5]; unsigned char x3[2][5]; unsigned char x4[2][5]; }*)arg3;
