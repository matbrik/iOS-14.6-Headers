...
- (void)dataMigratorDidFinish:(id <WLDataMigratorProtocol>)arg1 withImportErrors:(bool)arg2 skippedPhotos:(unsigned long long)arg3 skippedVideos:(unsigned long long)arg4;
