...
- (void)_tileGroupsForState:(long long)arg1 eager:(bool)arg2 withContext:(id)arg3;
...
- (void)_updateGroupStateForGroupViewInModalPresentation:(id)arg1 withState:(long long)arg2 animated:(bool)arg3 withContext:(id)arg4;
...
- (void)setPresentationState:(long long)arg1 withContext:(id)arg2 animated:(bool)arg3 completion:(id /* block */)arg4;
