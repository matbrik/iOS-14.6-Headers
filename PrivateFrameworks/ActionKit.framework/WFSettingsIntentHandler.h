...
@interface WFSettingsIntentHandler : NSObject <WFSetAirplaneModeIntentHandling, WFSetAppearanceIntentHandling, WFSetBluetoothIntentHandling, WFSetBrightnessIntentHandling, WFSetCellularDataIntentHandling, WFSetFlashlightIntentHandling, WFSetLowPowerModeIntentHandling, WFSetOrientationLockIntentHandling, WFSetWiFiIntentHandling>
