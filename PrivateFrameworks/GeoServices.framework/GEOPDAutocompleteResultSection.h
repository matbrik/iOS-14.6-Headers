...
@property (nonatomic) bool hasEnableMapsSuggestServerReranking;
...
- (bool)hasEnableMapsSuggestServerReranking;
...
- (void)setEnableMapsSuggestServerReranking:(bool)arg1;
- (void)setEnforceServerResultsOrder:(bool)arg1;
- (void)setEntries:(id)arg1;
- (void)setHasEnableMapsSuggestServerReranking:(bool)arg1;
