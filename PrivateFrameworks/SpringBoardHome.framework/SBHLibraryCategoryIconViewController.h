...
@interface SBHLibraryCategoryIconViewController : UIViewController <SBFolderObserver, SBHLegibility, SBIconViewCustomImageViewControlling, SBIconViewQuerying> {
