...
@interface CKVTaskCoalescenceManager : NSObject {
    ...
    NSMutableDictionary * _latestEventForTask;
...
- (bool)_doesFutureTaskExist:(id)arg1 eventId:(id)arg2;
...
- (void)submitTaskWithId:(unsigned short)arg1 taskBlock:(id /* block */)arg2;
- (id)transaction;
