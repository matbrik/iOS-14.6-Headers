...
- (bool)_isCacheContentValidForBundleID:(id)arg1 error:(id*)arg2;
- (bool)_isEligibleImmediateContentAvailable:(id)arg1;
...
- (void)notifyContentForDisplayAnimated:(bool)arg1;
