...
@property (nonatomic) bool hasShouldEnableGrayscaleHighlighting;
@property (nonatomic) bool hasShouldUseDistanceFeatureServerResults;
...
- (bool)hasShouldUseDistanceFeatureServerResults;
...
- (void)setHasShouldEnableGrayscaleHighlighting:(bool)arg1;
- (void)setHasShouldUseDistanceFeatureServerResults:(bool)arg1;
- (void)setIsNoResultFromNegativeCache:(bool)arg1;
- (void)setIsTopSectionTypeQuery:(bool)arg1;
- (void)setParsecQueryRankingFeatures:(id)arg1;
...
- (void)setShouldEnableGrayscaleHighlighting:(bool)arg1;
- (void)setShouldUseDistanceFeatureServerResults:(bool)arg1;
