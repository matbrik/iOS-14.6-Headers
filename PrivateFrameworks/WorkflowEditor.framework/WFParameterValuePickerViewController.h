...
@interface WFParameterValuePickerViewController : UITableViewController <UISearchBarDelegate, UISearchResultsUpdating, UITableViewDelegatePrivate, WFParameterEventObserver> {
