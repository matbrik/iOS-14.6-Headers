...
@property (nonatomic, retain) CHPostProcessingManager *ovsCleanupPostProcessor;
...
- (id).cxx_construct;
- (void).cxx_destruct;
- (id)_activationMatrixFromInferenceCache:(id)arg1 forDrawing:(id)arg2 outStrokeEndings:(struct vector<long, std::__1::allocator<long>> { long long *x1; long long *x2; struct __compressed_pair<long *, std::__1::allocator<long>> { long long *x_3_1_1; } x3; }*)arg3;
...
- (void)setOvsCleanupPostProcessor:(id)arg1;
