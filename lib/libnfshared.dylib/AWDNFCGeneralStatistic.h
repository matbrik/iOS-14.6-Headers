...
@property (nonatomic) bool hasTotalMWExceptions;
...
@property (nonatomic) unsigned int totalMWExceptions;
...
- (void)setHasTotalMWExceptions:(bool)arg1;
...
- (void)setTotalMWExceptions:(unsigned int)arg1;
...
- (unsigned int)totalMWExceptions;
