...
- (bool)businessWelcomeHasBeenDisplayed;
...
- (void)displayBusinessWelcomeIfNecessary;
...
- (void)presentBusinessWelcomeController;
...
- (void)setBusinessWelcomeHasBeenDisplayed;
...
- (void)setInfoButtonImage:(id)arg1;
