...
- (void)reportUserPreferencesOnLaunchForIconsInTabsEnabled:(bool)arg1 javaScriptEnabled:(bool)arg2 safeBrowsingEnabled:(bool)arg3 siteSpecificSearchEnabled:(bool)arg4 trackingPolicy:(unsigned long long)arg5;
