...
@property (nonatomic, retain) HUGridServiceCell *pressedTile;
...
@property (nonatomic, retain) HUItemTableViewController *settingsViewController;
...
@property (nonatomic, retain) HUHomeStatusDetailsViewController *statusDetailsViewController;
