...
- (void)runTransactionWithPreferredMediaUserUser:(id)arg1 selectionType:(unsigned long long)arg2 completion:(id /* block */)arg3;
- (id)runtimeState;
