...
@interface FTRecoverPronsRequest : NSObject <FLTBFBufferAccessor, NSCopying> {
    NSData * _data;
    const struct RecoverPronsRequest { unsigned char x1[1]; } * _root;
...
- (id)initWithFlatbuffData:(id)arg1 root:(const struct RecoverPronsRequest { unsigned char x1[1]; }*)arg2;
- (id)initWithFlatbuffData:(id)arg1 root:(const struct RecoverPronsRequest { unsigned char x1[1]; }*)arg2 verify:(bool)arg3;
- (id)language;
- (id)session_id;
- (id)speech_id;
