...
- (void)generateSubscriptionLeaseRequestWithAccountUniqueID:(unsigned long long)arg1 transactionType:(unsigned int)arg2 completionHandler:(id /* block */)arg3;
...
- (void)stopSubscriptionLeaseWithCompletion:(id /* block */)arg1;
