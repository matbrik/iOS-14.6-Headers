...
- (struct _PASDBIterAction_ { bool x1; })_updateURLs:(id)arg1 stmt:(struct sqlite3_stmt { }*)arg2;
...
- (void)deleteEmailContext75977305;
...
- (id)loadEntitiesBySourceKey:(id)arg1 entityType:(long long)arg2 resolveDuplicates:(id /* block */)arg3;
