...
@interface WDAtrialFibrillationEventOverviewViewController : HKTableViewController <HKHeartRhythmAvailabilityObserver, HKOnboardingSetupViewDelegate, HRAtrialFibrillationOnboardingManagerDelegate, HRFeatureRegulatoryReenableFeatureActionDelegate, UITextViewDelegate> {
    ...
    long long  _previousAtrialFibrillationDetectionRescindedCache;
    WDProfile * _profile;
...
@property (nonatomic) long long previousAtrialFibrillationDetectionRescindedCache;
...
- (long long)previousAtrialFibrillationDetectionRescindedCache;
- (id)profile;
...
- (void)setPreviousAtrialFibrillationDetectionRescindedCache:(long long)arg1;
