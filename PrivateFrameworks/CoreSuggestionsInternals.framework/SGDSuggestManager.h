...
- (void)_performAction:(id)arg1 onContactDetailRecord:(id)arg2 completion:(id /* block */)arg3 confirmRejectUI:(int)arg4;
- (void)_performAction:(id)arg1 onRecord:(id)arg2 completion:(id /* block */)arg3 rejectionUI:(int)arg4;
- (void)_performAction:(id)arg1 onRecord:(id)arg2 completion:(id /* block */)arg3 withParentConfirmation:(bool)arg4 confirmRejectUI:(int)arg5;
- (id)_pmlTraining;
...
- (void)_suggestionsFromMessageWithIdentifier:(id)arg1 options:(unsigned long long)arg2 completion:(id /* block */)arg3 completionDelivery:(unsigned long long)arg4 providedBy:(id /* block */)arg5 searchableItem:(id)arg6 dissectIfNecessary:(bool)arg7;
...
- (void)processInteractions:(id)arg1 bundleId:(id)arg2 completion:(id /* block */)arg3;
...
- (void)rejectContact:(id)arg1 completion:(id /* block */)arg2 rejectionUI:(int)arg3;
- (void)rejectContactDetailRecord:(id)arg1 completion:(id /* block */)arg2 rejectionUI:(int)arg3;
...
- (void)rejectRecord:(id)arg1 completion:(id /* block */)arg2 rejectionUI:(int)arg3;
