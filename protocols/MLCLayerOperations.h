...
- (NSArray *)lstmLayerWithDescriptor:(MLCLSTMDescriptor *)arg1 inputWeights:(NSArray *)arg2 hiddenWeights:(NSArray *)arg3 peepholeWeights:(NSArray *)arg4 biasTerms:(NSArray *)arg5 gateActivations:(NSArray *)arg6 outputResultActivation:(MLCActivationDescriptor *)arg7;
- (NSArray *)neuronLayerWithDescriptor:(MLCActivationDescriptor *)arg1;
- (NSArray *)paddingLayerWithPaddingType:(int)arg1 paddingLeft:(unsigned long long)arg2 paddingRight:(unsigned long long)arg3 paddingTop:(unsigned long long)arg4 paddingBottom:(unsigned long long)arg5 constantValue:(float)arg6;
...
- (NSArray *)optimizerAdamWithDescriptor:(MLCOptimizerDescriptor *)arg1 beta1:(float)arg2 beta2:(float)arg3 epsilon:(float)arg4 timeStep:(unsigned long long)arg5;
