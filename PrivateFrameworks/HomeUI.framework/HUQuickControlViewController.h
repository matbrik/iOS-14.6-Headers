...
@interface HUQuickControlViewController : UIViewController <HUPreloadableViewController, HUQuickControlContentCharacteristicWriting, HUQuickControlInteractiveContentContaining, HUQuickControlItemHosting> {
    ...
    <HUQuickControlContentRequiringHelper> * _childVCThatRequiresHelper;
    NSSet * _controlItems;
...
@property (nonatomic, retain) <HUQuickControlContentRequiringHelper> *childVCThatRequiresHelper;
...
- (void)setChildVCThatRequiresHelper:(id)arg1;
