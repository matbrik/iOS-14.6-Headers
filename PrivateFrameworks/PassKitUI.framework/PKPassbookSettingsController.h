...
@interface PKPassbookSettingsController : NSObject <PKInboxDataSourceDelegate, PKPaymentDataProviderDelegate, PKPaymentPassTableCellDelegate, PKPaymentServiceDelegate, PKPaymentVerificationControllerDelegate, PKPeerPaymentAccountResolutionControllerDelegate, PKSubcredentialProvisioningFlowControllerDelegate, PKSwitchSpinnerTableCellDelegate> {
