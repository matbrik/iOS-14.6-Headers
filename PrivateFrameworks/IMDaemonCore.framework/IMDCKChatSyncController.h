...
- (void)_processModifyPerRecordCallBack:(id)arg1 error:(id)arg2 isUsingStingRay:(bool)arg3 recordIDtoGUIDmap:(id)arg4;
...
- (void)syncChatsWithType:(long long)arg1 withActivity:(id)arg2 withCompletion:(id /* block */)arg3;
