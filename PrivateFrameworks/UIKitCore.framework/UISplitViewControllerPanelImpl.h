...
- (void)getPrimaryColumnWidth:(double*)arg1 supplementaryColumnWidth:(double*)arg2 forSize:(struct CGSize { double x1; double x2; })arg3 displayMode:(long long)arg4 isCompact:(bool)arg5 shouldUseOverlay:(bool)arg6 forceNoSupplementaryFill:(bool)arg7;
