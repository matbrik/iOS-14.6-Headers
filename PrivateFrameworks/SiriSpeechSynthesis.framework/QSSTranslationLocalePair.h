...
@interface QSSTranslationLocalePair : NSObject <FLTBFBufferAccessor, NSCopying> {
    NSData * _data;
    const struct TranslationLocalePair { unsigned char x1[1]; } * _root;
