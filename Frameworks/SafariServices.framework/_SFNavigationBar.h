...
@interface _SFNavigationBar : UIView <UIDragInteractionDelegate_Private, UIDropInteractionDelegate_Private, UIGestureRecognizerDelegate, _SFFluidProgressViewDelegate, _SFNavigationBarCommon, _SFNavigationBarItemObserver, _SFNavigationBarURLButtonDelegate, _UIBasicAnimationFactory, _UIClickInteractionDelegate> {
