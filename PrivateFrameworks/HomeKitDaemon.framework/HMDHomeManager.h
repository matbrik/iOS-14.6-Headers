...
@interface HMDHomeManager : HMFObject <HAPFragmentationStreamDelegate, HMDAccessoryBrowserManagerDelegate, HMDBackingStoreObjectProtocol, HMDBiomeLogEventObserverDataSource, HMDBiomeMigrationManagerDataSource, HMDCloudManagerDelegate, HMDDeviceSetupSessionDelegate, HMDDuetPredictionSubscriberDataSource, HMDLogEventDailyProvider, HMDMobileAssetManagerDelegate, HMDMultiUserStatusControllerDelegate, HMDPairedSyncDelegate, HMDSyncOperationManagerDataSource, HMDUserManagementOperationDelegate, HMFLogging, HMFMessageReceiver, HMFTimerDelegate> {
...
@property (nonatomic, readonly) HMDProximityCardLauncher *proximityCardLauncher;
...
- (id)init;
- (id)initWithMessageDispatcher:(id)arg1 accessoryBrowser:(id)arg2 messageFilterChain:(id)arg3 homeData:(id)arg4 localDataDecryptionFailed:(bool)arg5 identityRegistry:(id)arg6 accountRegistry:(id)arg7 metricsManager:(id)arg8;
