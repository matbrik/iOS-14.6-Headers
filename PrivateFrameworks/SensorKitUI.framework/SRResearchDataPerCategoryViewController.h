...
@interface SRResearchDataPerCategoryViewController : UITableViewController <SRAuthorizationCellDelegate, SRAuthorizationStoreReaderAuthorizationDelegate, SRSensorPrunerDelegate, SRSensorReaderDelegate> {
    NSArray * _appBundles;
