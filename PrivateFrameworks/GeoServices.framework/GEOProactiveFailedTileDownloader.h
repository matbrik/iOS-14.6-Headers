...
- (void).cxx_destruct;
- (void)_addMoreKeysToListIfNeeded:(id)arg1 completionHandler:(id /* block */)arg2;
...
- (id)initWithDiskCache:(id)arg1 delegate:(id)arg2 delegateQueue:(id)arg3 tileRequesterCreationBlock:(id /* block */)arg4;
