...
- (id)init;
- (id)initWithJSONObject:(struct Ref<WTF::JSONImpl::Object, WTF::RawPtrTraits<WTF::JSONImpl::Object>> { struct Object {} *x1; }*)arg1;
...
- (void)setJSONArray:(struct Ref<WTF::JSONImpl::Array, WTF::RawPtrTraits<WTF::JSONImpl::Array>> { struct Array {} *x1; }*)arg1 forKey:(id)arg2;
