...
@interface ATXModeEntityCorrelatorInternalState : NSObject {
    ...
    NSMutableDictionary * _numUniqueIncomingInteractionContactsPerBundleId;
    NSMutableDictionary * _numUniqueOutgoingInteractionContactsPerBundleId;
...
@property (nonatomic, retain) NSMutableDictionary *numUniqueIncomingInteractionContactsPerBundleId;
@property (nonatomic, retain) NSMutableDictionary *numUniqueOutgoingInteractionContactsPerBundleId;
...
- (id)numUniqueIncomingInteractionContactsPerBundleId;
- (id)numUniqueOutgoingInteractionContactsPerBundleId;
...
- (void)setNumUniqueIncomingInteractionContactsPerBundleId:(id)arg1;
- (void)setNumUniqueOutgoingInteractionContactsPerBundleId:(id)arg1;
