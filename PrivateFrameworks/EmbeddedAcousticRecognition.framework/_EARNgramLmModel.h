...
@property (nonatomic, readonly) struct shared_ptr<quasar::NgramSrilmConfig> { struct NgramSrilmConfig {} *x1; struct __shared_weak_count {} *x2; } ngramBuildConfig;
...
- (id).cxx_construct;
- (void).cxx_destruct;
- (id)_initWithModel:(struct shared_ptr<quasar::NgramLmModel2> { struct NgramLmModel2 {} *x1; struct __shared_weak_count {} *x2; })arg1 config:(struct shared_ptr<quasar::NgramSrilmConfig> { struct NgramSrilmConfig {} *x1; struct __shared_weak_count {} *x2; })arg2;
- (id)arpaFileName;
- (id)generateNgramCounts:(id)arg1;
- (id)initFromDirectory:(id)arg1;
- (id)initWithConfiguration:(id)arg1;
- (id)initWithConfiguration:(id)arg1 root:(id)arg2;
- (struct shared_ptr<quasar::NgramSrilmConfig> { struct NgramSrilmConfig {} *x1; struct __shared_weak_count {} *x2; })ngramBuildConfig;
