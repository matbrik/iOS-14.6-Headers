...
@interface AXMAudioDataSource : NSObject {
    ...
    double  _level;
    NSString * _name;
    struct vector<int, std::__1::allocator<int>> { int *x1; int *x2; struct __compressed_pair<int *, std::__1::allocator<int>> { int *x_3_1_1; } x3; } * _sampleBuffer;
    double  _sampleRate;
}
...
@property (nonatomic, readonly) /* Warning: unhandled struct encoding: '{vector<int' */ struct *sampleBuffer; /* unknown property attribute:  std::__1::allocator<int>>=^i}} */
...
- (struct vector<int, std::__1::allocator<int>> { int *x1; int *x2; struct __compressed_pair<int *, std::__1::allocator<int>> { int *x_3_1_1; } x3; }*)sampleBuffer;
- (double)sampleRate;
