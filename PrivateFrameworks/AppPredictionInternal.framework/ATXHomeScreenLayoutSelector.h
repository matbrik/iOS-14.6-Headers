...
- (id)initWithHomeScreenPageConfigurations:(id)arg1 rankedSuggestions:(id)arg2 suggestionsWidgetsShouldBeDisjointOnAPage:(bool)arg3 suggestionDeduplicator:(id)arg4 engagementRecordManager:(id)arg5 stackStateTracker:(id)arg6 isiPad:(bool)arg7;
- (id)pagesByAppendingTodayPageContentsToFirstHomeScreenPage:(id)arg1;
