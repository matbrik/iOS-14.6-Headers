...
@interface SBIconView : UIView <SBCloseBoxViewDelegate, SBHStackConfigurationInteractionDelegate, SBIconAccessoryInfoProvider, SBIconObserver, SBIconViewCustomImageViewControllerObserving, SBReusableView, SBSHardwareButtonEventConsuming, UIContextMenuInteractionDelegate, UIDragInteractionDelegate, UIGestureRecognizerDelegate, UIPointerInteractionDelegate, _UISettingsKeyObserver> {
    ...
    unsigned int  _privateModeEnabled;
    unsigned int  _reallyHasPopover;
    unsigned int  _reallyHasWidget;
...
+ (id)_jitterRotationAnimationForGridSize:(struct SBHIconGridSize { unsigned short x1; unsigned short x2; })arg1;
