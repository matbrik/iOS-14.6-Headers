...
@interface WFAirportViewController : WFInsetViewController <UITableViewDataSource, UITableViewDelegate, WFNetworkListing> {
    ...
    <WFNetworkListRecord> * _pendingCurrentNetwork;
...
@property (nonatomic, retain) <WFNetworkListRecord> *pendingCurrentNetwork;
...
- (void)setPendingCurrentNetwork:(id)arg1;
