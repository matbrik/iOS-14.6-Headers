...
- (void)_speakPasscode:(id)arg1 instructions:(id)arg2 languageCode:(id)arg3 voiceName:(id)arg4 flags:(unsigned int)arg5 completion:(id /* block */)arg6;
...
- (void)speakPasscode:(id)arg1 instructions:(id)arg2 languageCode:(id)arg3 voiceName:(id)arg4 flags:(unsigned int)arg5 completion:(id /* block */)arg6;
