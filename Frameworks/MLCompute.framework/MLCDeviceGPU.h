...
@property (nonatomic, retain) NSMutableArray *gpuPipelineStatesMHAMaskForward;
...
- (id)gpuPipelineStatesMHAMaskForward;
...
- (void)setGpuPipelineStatesMHAMaskForward:(id)arg1;
