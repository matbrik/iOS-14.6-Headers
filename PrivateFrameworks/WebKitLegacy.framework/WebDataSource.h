...
@property (setter=_setQuickLookPreviewLoaderClient:, nonatomic) struct LegacyPreviewLoaderClient { int (**x1)(); unsigned int x2; }*_quickLookPreviewLoaderClient;
...
- (id)_initWithDocumentLoader:(struct Ref<WebDocumentLoaderMac, WTF::RawPtrTraits<WebDocumentLoaderMac>> { struct WebDocumentLoaderMac {} *x1; }*)arg1;
- (bool)_isDocumentHTML;
- (id)_mainDocumentError;
- (void)_makeRepresentation;
- (id)_quickLookContent;
- (struct LegacyPreviewLoaderClient { int (**x1)(); unsigned int x2; }*)_quickLookPreviewLoaderClient;
...
- (void)_setQuickLookPreviewLoaderClient:(struct LegacyPreviewLoaderClient { int (**x1)(); unsigned int x2; }*)arg1;
