...
@property (getter=avKitEnabled, nonatomic) bool AVKitEnabled;
...
@property (getter=cssLogicalEnabled, nonatomic) bool CSSLogicalEnabled;
...
@property (setter=_setAlwaysUseAcceleratedOverflowScroll:, nonatomic) bool _alwaysUseAcceleratedOverflowScroll;
...
- (void)setAudioWorkletEnabled:(bool)arg1;
