...
@interface IMChat : IMItemsController <IMSendProgressDelegate, IMStateLoggable, INSpeakable> {
    IMAccount * _account;
...
@property (nonatomic, readonly) bool hasReceivedResponse;
...
@property (nonatomic, readonly) bool hasResponded;
...
@property (nonatomic, retain) NSMutableArray *mentionMessageGuidsToRemove;
...
@property (nonatomic) long long smsHandshakeState;
...
- (id)identityHash;
- (unsigned int)ignoreDowngradeStatusUpdates;
- (id)init;
...
- (id)mentionMessageGuidsToRemove;
...
- (void)setIgnoreDowngradeStatusUpdates:(unsigned int)arg1;
...
- (void)setMentionMessageGuidsToRemove:(id)arg1;
