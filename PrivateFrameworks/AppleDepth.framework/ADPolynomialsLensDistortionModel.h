...
- (void)distortPixels:(unsigned long long)arg1 undistortedPixels:(const struct CGPoint { double x1; double x2; }*)arg2 withPixelSize:(double)arg3 referenceDimensions:(struct CGSize { double x1; double x2; })arg4 outDistortedPixels:(struct CGPoint { double x1; double x2; }*)arg5;
...
- (void)undistortPixels:(unsigned long long)arg1 distortedPixels:(const struct CGPoint { double x1; double x2; }*)arg2 withPixelSize:(double)arg3 referenceDimensions:(struct CGSize { double x1; double x2; })arg4 outUndistortedPixels:(struct CGPoint { double x1; double x2; }*)arg5;
