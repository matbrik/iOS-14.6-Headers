...
+ (id)_modernBackgroundSelected:(bool)arg1 disableShadow:(bool)arg2 maximumSize:(struct CGSize { double x1; double x2; })arg3 highlighted:(bool)arg4 traitCollection:(id)arg5 tintColor:(id)arg6 size:(int)arg7;
