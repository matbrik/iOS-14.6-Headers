...
@interface CSBuiltInVoiceTrigger : NSObject <CSActivationEventNotificationHandlerDelegate, CSAudioRouteChangeMonitorDelegate, CSAudioServerCrashMonitorDelegate, CSAudioStreamProvidingDelegate, CSBluetoothWirelessSplitterMonitorDelegate, CSKeywordAnalyzerNDAPIScoreDelegate, CSPhoneCallStateMonitorDelegate, CSSecondPassProgressProviding, CSSelfTriggerDetectorDelegate, CSSiriClientBehaviorMonitorDelegate, CSStateMachineDelegate, CSVoiceTriggerXPCServiceProxyDelegate> {
...
- (void)hasSecondPassRunning:(id /* block */)arg1;
