...
- (void)addAssertionNeedingBackgroundTask:(struct ProcessAndUIAssertion { int (**x1)(); struct WeakPtrFactory<WebKit::ProcessAssertion, WTF::EmptyCounter> { struct RefPtr<WTF::WeakPtrImpl<WTF::EmptyCounter>, WTF::RawPtrTraits<WTF::WeakPtrImpl<WTF::EmptyCounter>>, WTF::DefaultRefDerefTraits<WTF::WeakPtrImpl<WTF::EmptyCounter>>> { struct WeakPtrImpl<WTF::EmptyCounter> {} *x_1_2_1; } x_2_1_1; } x2; int x3; int x4; struct RetainPtr<RBSAssertion> { void *x_5_1_1; } x5; struct RetainPtr<WKRBSAssertionDelegate> { void *x_6_1_1; } x6; struct Function<void ()>={unique_ptr<WTF::Detail::CallableWrapperBase<void>, std::__1::default_delete<WTF::Detail::CallableWrapperBase<void>>>={__compressed_pair<WTF::Detail::CallableWrapperBase<void> *, std::__1::default_delete<WTF::Detail::CallableWrapperBase<void>>>=^{CallableWrapperBase<void> {} x7; }*)arg1;
- (void)assertion:(id)arg1 didInvalidateWithError:(id)arg2;
- (void)assertionWillInvalidate:(id)arg1;
- (void)dealloc;
- (id)init;
- (void)removeAssertionNeedingBackgroundTask:(struct ProcessAndUIAssertion { int (**x1)(); struct WeakPtrFactory<WebKit::ProcessAssertion, WTF::EmptyCounter> { struct RefPtr<WTF::WeakPtrImpl<WTF::EmptyCounter>, WTF::RawPtrTraits<WTF::WeakPtrImpl<WTF::EmptyCounter>>, WTF::DefaultRefDerefTraits<WTF::WeakPtrImpl<WTF::EmptyCounter>>> { struct WeakPtrImpl<WTF::EmptyCounter> {} *x_1_2_1; } x_2_1_1; } x2; int x3; int x4; struct RetainPtr<RBSAssertion> { void *x_5_1_1; } x5; struct RetainPtr<WKRBSAssertionDelegate> { void *x_6_1_1; } x6; struct Function<void ()>={unique_ptr<WTF::Detail::CallableWrapperBase<void>, std::__1::default_delete<WTF::Detail::CallableWrapperBase<void>>>={__compressed_pair<WTF::Detail::CallableWrapperBase<void> *, std::__1::default_delete<WTF::Detail::CallableWrapperBase<void>>>=^{CallableWrapperBase<void> {} x7; }*)arg1;
