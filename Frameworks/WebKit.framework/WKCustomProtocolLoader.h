...
- (void)dealloc;
- (id)initWithLegacyCustomProtocolManagerProxy:(struct LegacyCustomProtocolManagerProxy { int (**x1)(); struct WeakPtrFactory<WebKit::LegacyCustomProtocolManagerProxy, WTF::EmptyCounter> { struct RefPtr<WTF::WeakPtrImpl<WTF::EmptyCounter>, WTF::RawPtrTraits<WTF::WeakPtrImpl<WTF::EmptyCounter>>, WTF::DefaultRefDerefTraits<WTF::WeakPtrImpl<WTF::EmptyCounter>>> { struct WeakPtrImpl<WTF::EmptyCounter> {} *x_1_2_1; } x_2_1_1; } x2; struct NetworkProcessProxy {} *x3; }*)arg1 customProtocolID:(struct ObjectIdentifier<WebKit::LegacyCustomProtocolIDType> { unsigned long long x1; })arg2 request:(id)arg3;
