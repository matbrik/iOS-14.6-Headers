...
@property (nonatomic, readonly) /* Warning: unhandled struct encoding: '{Unit<RadianUnitDescription' */ struct  horizontalFieldOfView; /* unknown property attribute:  double>=d} */
...
@property (nonatomic) /* Warning: unhandled struct encoding: '{Unit<RadianUnitDescription' */ struct  verticalFieldOfView; /* unknown property attribute:  double>=d} */
...
- (struct VKCameraState { struct RigidTransform<double, double> { struct Matrix<double, 3, 1> { double x_1_2_1[3]; } x_1_1_1; struct Quaternion<double> { struct Matrix<double, 3, 1> { double x_1_3_1[3]; } x_2_2_1; double x_2_2_2; } x_1_1_2; } x1; double x2; struct Unit<RadianUnitDescription, double> { double x_3_1_1; } x3; double x4; })cameraState;
...
- (void)setMercatorPosition:(const struct Mercator3<double> { double x1[3]; }*)arg1;
...
- (void)setVerticalFieldOfView:(struct Unit<RadianUnitDescription, double> { double x1; })arg1;
...
- (void)updateIfNeeded;
- (struct Unit<RadianUnitDescription, double> { double x1; })verticalFieldOfView;
