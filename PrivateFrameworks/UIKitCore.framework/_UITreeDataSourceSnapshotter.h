...
- (id)init;
- (id)initWithNodes:(struct vector<_UIOutlineNode, std::__1::allocator<_UIOutlineNode>> { struct _UIOutlineNode {} *x1; struct _UIOutlineNode {} *x2; struct __compressed_pair<_UIOutlineNode *, std::__1::allocator<_UIOutlineNode>> { struct _UIOutlineNode {} *x_3_1_1; } x3; })arg1 count:(long long)arg2 expandedIndexes:(id)arg3;
