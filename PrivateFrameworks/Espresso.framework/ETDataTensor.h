...
@property /* Warning: unhandled struct encoding: '{vector<std::__1::shared_ptr<unsigned char>' */ struct  allocatedImageData; /* unknown property attribute:  std::__1::allocator<std::__1::shared_ptr<unsigned char>>>=^{shared_ptr<unsigned char>}}} */
@property /* Warning: unhandled struct encoding: '{shared_ptr<Espresso::blob<float' */ struct  blob; /* unknown property attribute:  4>}^{__shared_weak_count}} */
...
- (id).cxx_construct;
- (void).cxx_destruct;
- (struct vector<std::__1::shared_ptr<unsigned char>, std::__1::allocator<std::__1::shared_ptr<unsigned char>>> { struct shared_ptr<unsigned char> {} *x1; struct shared_ptr<unsigned char> {} *x2; struct __compressed_pair<std::__1::shared_ptr<unsigned char> *, std::__1::allocator<std::__1::shared_ptr<unsigned char>>> { struct shared_ptr<unsigned char> {} *x_3_1_1; } x3; })allocatedImageData;
- (struct shared_ptr<Espresso::blob<float, 4>> { struct blob<float, 4> {} *x1; struct __shared_weak_count {} *x2; })blob;
- (id)dataArray;
- (void*)dataPointer;
- (id)description;
...
- (void)setAllocatedImageData:(struct vector<std::__1::shared_ptr<unsigned char>, std::__1::allocator<std::__1::shared_ptr<unsigned char>>> { struct shared_ptr<unsigned char> {} *x1; struct shared_ptr<unsigned char> {} *x2; struct __compressed_pair<std::__1::shared_ptr<unsigned char> *, std::__1::allocator<std::__1::shared_ptr<unsigned char>>> { struct shared_ptr<unsigned char> {} *x_3_1_1; } x3; })arg1;
- (void)setBlob:(struct shared_ptr<Espresso::blob<float, 4>> { struct blob<float, 4> {} *x1; struct __shared_weak_count {} *x2; })arg1;
