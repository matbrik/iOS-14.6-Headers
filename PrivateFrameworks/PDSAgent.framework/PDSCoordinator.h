...
@interface PDSCoordinator : NSObject <IDSPushHandlerDelegate, IMSystemMonitorListener, PDSEntryStoreDelegate, PDSRequestQueueDelegate> {
...
@property (nonatomic, retain) IMTimer *heartbeatTimer;
...
@property (nonatomic, retain) PDSBag *serverBag;
...
- (id)heartbeatTimer;
- (id)initWithQueue:(id)arg1 serverBag:(id)arg2 requestQueue:(id)arg3 kvStoreBlock:(id /* block */)arg4 entryStoreBlock:(id /* block */)arg5 pushTokenBlock:(id /* block */)arg6 systemMonitor:(id)arg7;
