...
@interface WKPDFView : WKApplicationStateTrackingView <PDFHostViewControllerDelegate, WKActionSheetAssistantDelegate, WKShareSheetDelegate, WKWebViewContentProvider, _WKWebViewPrintProvider> {
