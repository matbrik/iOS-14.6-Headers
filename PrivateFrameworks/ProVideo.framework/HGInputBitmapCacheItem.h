...
- (id)initWithHGBitmap:(struct vector<HGRef<HGBitmap>, std::__1::allocator<HGRef<HGBitmap>>> { struct HGRef<HGBitmap> {} *x1; struct HGRef<HGBitmap> {} *x2; struct __compressed_pair<HGRef<HGBitmap> *, std::__1::allocator<HGRef<HGBitmap>>> { struct HGRef<HGBitmap> {} *x_3_1_1; } x3; }*)arg1 fullSize:(struct CGSize { double x1; double x2; })arg2 colorSpace:(id)arg3;
- (id)lastUsedTime;
