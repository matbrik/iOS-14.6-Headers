...
- (id)_autoReplier;
- (void)_blastDoorProcessingWithIMMessageItem:(id)arg1 chat:(id)arg2 account:(id)arg3 fromToken:(id)arg4 fromIDSID:(id)arg5 fromIdentifier:(id)arg6 toIdentifier:(id)arg7 participants:(id)arg8 groupName:(id)arg9 groupID:(id)arg10 isEncrypted:(bool)arg11 isFromMe:(bool)arg12 isLastFromStorage:(bool)arg13 isFromStorage:(bool)arg14 hideLockScreenNotification:(bool)arg15 wantsCheckpointing:(bool)arg16 needsDeliveryReceipt:(id)arg17 messageBalloonPayloadAttachmentDictionary:(id)arg18 inlineAttachments:(id)arg19 attributionInfoArray:(id)arg20 nicknameDictionary:(id)arg21 messageContext:(id)arg22 completionBlock:(id /* block */)arg23;
