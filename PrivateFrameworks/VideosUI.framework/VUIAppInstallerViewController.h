...
@property (nonatomic, retain) VUIAppInstallConfirmationViewController *confirmationController;
...
@property (nonatomic, retain) VUIASDDialogObserver *dialogObserver;
...
- (void)setConfirmationController:(id)arg1;
