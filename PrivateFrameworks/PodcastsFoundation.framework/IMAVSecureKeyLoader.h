...
- (void)processContentKeyRequest:(id)arg1 requestType:(long long)arg2 completion:(id /* block */)arg3;
- (void)processContentKeyRequestWithKeyIdentifier:(id)arg1 contentAdamId:(id)arg2 isRenewal:(bool)arg3 completion:(id /* block */)arg4;
- (void)processContentKeyRequestWithKeyRequestData:(id)arg1 isRenewal:(bool)arg2 completion:(id /* block */)arg3;
- (id)recipient;
