...
- (void)_submitVoiceAssetWithLanguage:(id)arg1 andGender:(long long)arg2 andName:(id)arg3;
...
- (void)cacheAnnouncement:(id)arg1 privately:(bool)arg2;
- (id)carSessionStatus;
- (void)clearAllEvents;
