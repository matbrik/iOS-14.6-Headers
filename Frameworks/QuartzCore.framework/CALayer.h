...
@interface CALayer : NSObject <CAMediaTiming, CAPropertyInfo, CKAsyncTransactionContainer, NSSecureCoding, PXGInternalReusableView, TSDContentsScaleProviding> {
...
@property (setter=ck_setAllowsHighlightDrawing:, nonatomic) bool ck_allowsHighlightDrawing;
@property (setter=ck_setAsyncLayerTransactions:, nonatomic, retain) NSHashTable *ck_asyncLayerTransactions;
@property (nonatomic, readonly, retain) CKAsyncTransaction *ck_asyncTransaction;
...
@property (setter=ck_setCurrentAsyncLayerTransaction:, nonatomic, retain) CKAsyncTransaction *ck_currentAsyncLayerTransaction;
@property (nonatomic, readonly, retain) CALayer *ck_parentTransactionContainer;
...
- (id)ck_parentTransactionContainer;
- (void)ck_setAllowsHighlightDrawing:(bool)arg1;
