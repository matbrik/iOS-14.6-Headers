...
@interface CNAtomTextView : UIControl <NSLayoutManagerDelegate, UITextInput, UITextInputPrivate, UITextViewDelegate> {
    ...
    <CNAtomTextViewDelegateInternal> * _delegate;
...
@property (nonatomic) <CNAtomTextViewDelegate> *delegate;
