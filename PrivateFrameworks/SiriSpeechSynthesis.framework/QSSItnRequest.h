...
@interface QSSItnRequest : NSObject <FLTBFBufferAccessor, NSCopying> {
    NSData * _data;
    const struct ItnRequest { unsigned char x1[1]; } * _root;
