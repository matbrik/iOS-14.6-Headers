...
- (unsigned long long)_augmentSessionWithRequest:(id)arg1 serviceURL:(id)arg2 completion:(id /* block */)arg3;
...
- (void)_deviceProvisioningDataIncludingDeviceMetadata:(bool)arg1 withCompletion:(id /* block */)arg2;
...
- (unsigned long long)accountUsersWithRequest:(id)arg1 completion:(id /* block */)arg2;
...
- (id)archiver;
- (unsigned long long)augmentSessionWithRequest:(id)arg1 completion:(id /* block */)arg2;
...
- (unsigned long long)contactInformationWithRequest:(id)arg1 completion:(id /* block */)arg2;
- (id)context;
...
- (unsigned long long)createdZoneWithRequest:(id)arg1 completion:(id /* block */)arg2;
- (unsigned long long)credentialAccountAttesationWithRequest:(id)arg1 completion:(id /* block */)arg2;
- (unsigned long long)customizePhysicalCardWithRequest:(id)arg1 completion:(id /* block */)arg2;
- (void)dealloc;
- (id)delegates;
- (unsigned long long)deleteAccountUserWithRequest:(id)arg1 completion:(id /* block */)arg2;
...
- (unsigned long long)fetchBarcodesWithRequest:(id)arg1 completion:(id /* block */)arg2;
...
- (unsigned long long)notifyIssuerAppletStateDirtyWithRequest:(id)arg1 completion:(id /* block */)arg2;
...
- (unsigned long long)paymentProvisioningNonceOfType:(unsigned long long)arg1 completion:(id /* block */)arg2;
...
- (unsigned long long)physicalCardsWithRequest:(id)arg1 completion:(id /* block */)arg2;
...
- (unsigned long long)provideEncryptedPushProvisioningTargetWithRequest:(id)arg1 completion:(id /* block */)arg2;
...
- (unsigned long long)pushProvisioningSharingIdentifiersWithRequest:(id)arg1 completion:(id /* block */)arg2;
- (unsigned long long)pushProvisioningSharingStatusRequest:(id)arg1 completion:(id /* block */)arg2;
- (unsigned long long)registerAuxiliaryCapabilityWithRequest:(id)arg1 completion:(id /* block */)arg2;
- (unsigned long long)registerCredentialWithRequest:(id)arg1 withCompletion:(id /* block */)arg2;
- (unsigned long long)registerDeviceAtBrokerURL:(id)arg1 consistencyCheckResults:(id)arg2 completion:(id /* block */)arg3;
- (unsigned long long)registerDeviceAtBrokerURL:(id)arg1 withConsistencyCheckResults:(id)arg2 retries:(unsigned long long)arg3 completion:(id /* block */)arg4;
...
- (unsigned long long)revokeSharedCredentialWithRequest:(id)arg1 withCompletion:(id /* block */)arg2;
...
- (unsigned long long)sendOwnershipTokensForReason:(unsigned long long)arg1 completion:(id /* block */)arg2;
- (unsigned long long)serviceProviderAugmentSessionWithRequest:(id)arg1 completion:(id /* block */)arg2;
- (unsigned long long)serviceProviderNonceWithRequest:(id)arg1 completion:(id /* block */)arg2;
...
- (unsigned long long)sharedAccountCloudStoreWithRequest:(id)arg1 completion:(id /* block */)arg2;
...
- (unsigned long long)transactionReceiptAuthorizationWithRequest:(id)arg1 completion:(id /* block */)arg2;
- (unsigned long long)transactionReceiptWithRequest:(id)arg1 completion:(id /* block */)arg2;
...
- (unsigned long long)updateAccountUserPreferencesWithRequest:(id)arg1 completion:(id /* block */)arg2;
