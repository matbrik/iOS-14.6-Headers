...
@interface HFMediaAccessoryItem : HFItem <HFActionBuilderFactory, HFMediaAccessoryLikeItem, HFMediaAccessoryProtocol> {
...
@property (nonatomic, readonly) bool anyAccessorySupportsSoftwareUpdate;
...
- (id)settings;
- (bool)supportsAlarmAndTimerQuickControls;
