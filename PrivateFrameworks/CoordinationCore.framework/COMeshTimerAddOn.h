...
@interface COMeshTimerAddOn : COMeshAddOn <COTimerManagerServiceInterface, NSXPCListenerDelegate> {
    NSArray * _clients;
    NSArray * _deletes;
    ...
    <COTimerAddOnListenerProvider> * _provider;
...
@property (nonatomic, readonly) <COTimerAddOnListenerProvider> *provider;
...
- (id)addTimer:(id)arg1;
- (void)addTimer:(id)arg1 asInstance:(id)arg2 withCallback:(id /* block */)arg3;
...
- (void)dismissTimerWithIdentifier:(id)arg1 withCallback:(id /* block */)arg2;
...
- (void)removeTimer:(id)arg1 withCallback:(id /* block */)arg2;
...
- (id)timerManager;
- (id)timers;
- (void)timersforAccessoryUniqueIdentifier:(id)arg1 asInstance:(id)arg2 withCallback:(id /* block */)arg3;
- (id)updateTimer:(id)arg1;
- (void)updateTimer:(id)arg1 withCallback:(id /* block */)arg2;
