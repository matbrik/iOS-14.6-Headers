...
- (id)convertLUTTo16Bit:(struct HGRef<HGBitmap> { struct HGBitmap {} *x1; })arg1;
- (void)dealloc;
...
- (struct HGRef<HGNode> { struct HGNode {} *x1; })generateCoolNode:(struct HGRef<HGBitmap> { struct HGBitmap {} *x1; })arg1 withInput:(struct HGRef<HGNode> { struct HGNode {} *x1; })arg2;
