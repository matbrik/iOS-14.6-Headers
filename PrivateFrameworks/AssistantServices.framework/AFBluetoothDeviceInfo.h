...
- (id)initWithAddress:(id)arg1 deviceUID:(id)arg2 vendorID:(unsigned int)arg3 productID:(unsigned int)arg4 isAdvancedAppleAudioDevice:(bool)arg5 supportsInEarDetection:(bool)arg6 supportsVoiceTrigger:(bool)arg7 supportsSpokenNotification:(bool)arg8 supportsListeningModeANC:(bool)arg9 supportsListeningModeTransparency:(bool)arg10 supportsAnnounceCall:(bool)arg11;
