...
- (void)_handleTestAccessoryGenerateNotification:(id)arg1 responseHandler:(id /* block */)arg2;
- (void)_handleTestAccessoryReadValue:(id)arg1 responseHandler:(id /* block */)arg2;
- (void)_handleTestAccessorySetReachability:(id)arg1 responseHandler:(id /* block */)arg2;
- (void)_handleTestAccessorySetValue:(id)arg1 responseHandler:(id /* block */)arg2;
