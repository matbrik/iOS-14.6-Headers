...
- (id)initWithNetworkActivityParent:(id)arg1 concurrentStreams:(unsigned long long)arg2 timedUploadLength:(unsigned long long)arg3 endWhenStable:(bool)arg4 stopAtFileSize:(bool)arg5 callingClient:(id)arg6;
- (bool)isLastTask;
