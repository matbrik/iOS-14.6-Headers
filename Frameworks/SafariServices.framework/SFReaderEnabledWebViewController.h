...
@interface SFReaderEnabledWebViewController : SFWebViewController <WKNavigationDelegatePrivate, _SFAppBannerMetaTagContentObserver, _SFReaderControllerDelegate> {
