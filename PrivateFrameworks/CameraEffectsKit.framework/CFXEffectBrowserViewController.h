...
@interface CFXEffectBrowserViewController : UIViewController <AVTAvatarPickerDelegate, CFXEffectPickerViewControllerDelegate, IMADockViewControllerDelegate> {
    ...
    NSObject<OS_dispatch_queue> * _animojiLoadingQueue;
...
@property (nonatomic, retain) NSObject<OS_dispatch_queue> *animojiLoadingQueue;
...
- (void)setAnimojiLoadingQueue:(id)arg1;
