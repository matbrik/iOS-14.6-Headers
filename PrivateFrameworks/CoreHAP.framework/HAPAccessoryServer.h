...
@property (nonatomic, copy) NSString *pairVerifyReason;
...
@property (nonatomic, copy) NSDate *timePairVerifyStart;
...
- (void)setPairVerifyReason:(id)arg1;
...
- (void)setTimePairVerifyStart:(id)arg1;
