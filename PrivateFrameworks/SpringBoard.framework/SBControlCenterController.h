...
@interface SBControlCenterController : NSObject <CCUIHostStatusBarStyleProvider, CCUIModularControlCenterOverlayViewControllerDelegate, CSCoverSheetOverlaying, CSExternalAppearanceProviding, CSExternalBehaviorProviding, CSExternalPresentationProviding, SBBarSwipeAffordanceDelegate, SBBarSwipeAffordanceObserver, SBFIdleTimerBehaviorProviding, SBFSensorActivityObserver, SBGrabberTongueDelegate, SBHomeGrabberPointerClickDelegate, SBIdleTimerProviding, SBIndirectPanGestureRecognizerOrientationProviding, SBReachabilityObserver, SBSystemGestureRecognizerDelegate, UIGestureRecognizerDelegate> {
