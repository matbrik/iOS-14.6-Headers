...
@property (nonatomic, readonly) const struct __CFString { }*safari_protocolAsSecAttrProtocolValue;
...
- (const struct __CFString { }*)safari_protocolAsSecAttrProtocolValue;
