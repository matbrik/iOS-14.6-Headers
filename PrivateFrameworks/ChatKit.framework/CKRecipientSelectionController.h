...
@interface CKRecipientSelectionController : CKViewController <CKComposeRecipientViewDelegate, CKDetailsContactsManagerDelegate, CKRecipientSearchListControllerDelegate, CNAutocompleteGroupDetailViewControllerDelegate, CNComposeRecipientTextViewDelegate, CNContactPickerDelegate> {
