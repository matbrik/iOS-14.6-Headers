...
- (id)init;
- (id)initWithAdamId:(unsigned long long)arg1 urlHash:(id)arg2 location:(struct CLLocationCoordinate2D { double x1; double x2; })arg3 radiusInMeters:(unsigned long long)arg4 rank:(unsigned long long)arg5 isTouristApp:(bool)arg6 poiCategory:(id)arg7;
