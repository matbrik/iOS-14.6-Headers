...
- (id)_zoomRangeStringForZoomFactor:(float)arg1 devicePosition:(long long)arg2;
- (id)eventName;
...
- (void)populateZoomFromZoomButtonSymbol:(long long)arg1;
- (void)populateZoomFromZoomFactor:(float)arg1;
