...
@interface TPKContentView : UIView {
    ...
    bool  _ignoreRegularReadableLayoutGuide;
    bool  _isPopOverView;
...
@property (nonatomic) bool ignoreRegularReadableLayoutGuide;
...
- (bool)ignoreRegularReadableLayoutGuide;
- (id)init;
- (id)layoutIdentifier;
...
- (void)setIgnoreRegularReadableLayoutGuide:(bool)arg1;
