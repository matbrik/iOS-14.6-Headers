...
@interface REMList : NSObject <REMDAChangeTrackableFetchableModel, REMDAChangedModelObjectResult, REMExternalSyncMetadataProviding, REMObjectIDProviding, _REMDAChangeTrackableModel> {
    REMAccount * _account;
    REMList * _parentList;
