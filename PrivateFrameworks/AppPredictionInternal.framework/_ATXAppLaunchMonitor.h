...
- (id)initWithAppInfoManager:(id)arg1 appLaunchHistogramManager:(id)arg2 appLaunchSequenceManager:(id)arg3 appDailyDose:(id)arg4 duetHelper:(id)arg5 contextBuilder:(id)arg6 tracker:(id)arg7 heroPoiManager:(id)arg8;
