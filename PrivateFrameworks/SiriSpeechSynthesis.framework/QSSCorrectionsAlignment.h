...
@interface QSSCorrectionsAlignment : NSObject <FLTBFBufferAccessor, NSCopying> {
    NSData * _data;
    const struct CorrectionsAlignment { unsigned char x1[1]; } * _root;
