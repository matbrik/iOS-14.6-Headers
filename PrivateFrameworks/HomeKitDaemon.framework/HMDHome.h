...
@interface HMDHome : HMFObject <HMDAccessoryBrowserDelegate, HMDAppleMediaAccessoriesStateManagerDataSource, HMDAppleMediaAccessoriesStateManagerFactory, HMDAppleMediaAccessoriesStateManagerMetricsDispatcherFactory, HMDBackingStoreObjectProtocol, HMDBulletinIdentifiers, HMDHomeMediaSystemHandlerDelegate, HMDHomeMessageReceiver, HMDMediaActionRouterDataSource, HMDPrimaryResidentMessageRouterDataSource, HMDPrimaryResidentMessageRouterFactory, HMDPrimaryResidentMessageRouterMetricsDispatcherFactory, HMDRelayManagerDelegate, HMDResidentDeviceManagerDelegate, HMDUserManagementOperationDelegate, HMFDumpState, HMFLogging, HMFTimerDelegate, NSSecureCoding> {
    ...
    bool  _homepodSetupMetricIsAlreadySubmitted;
...
@property (readonly, copy) NSUUID *assistantUniqueIdentifier;
@property (nonatomic) long long atHomeLevel;
@property (nonatomic, retain) HMDBackingStore *backingStore;
@property (nonatomic, readonly) HMDBonjourBrowserHelper *borderRouterBrowser;
...
@property bool homepodSetupMetricIsAlreadySubmitted;
...
- (id /* block */)__readWriteResponseHandler:(id)arg1;
...
- (id /* block */)_handleRemoveAccessoryAfterUserConsentCompletion:(id)arg1 message:(id)arg2;
...
- (void)_registerForReachabilityChangeNotificationsEnabled:(bool)arg1;
...
- (id)createAppleMediaAccessoriesStateManagerMetricsDispatcherWithIdentifier:(id)arg1 logEventDispatcher:(id)arg2;
...
- (id)createPrimaryResidentMessageRouterMetricsDispatcherWithLogEventDispatcher:(id)arg1;
- (id)createPrimaryResidentMessageRouterWithMessageDispatcher:(id)arg1 metricsDispatcher:(id)arg2;
- (id)creationDate;
- (id)currentAccessory;
...
- (id)initWithName:(id)arg1 uuid:(id)arg2 defaultRoomUUID:(id)arg3 owner:(id)arg4 homeManager:(id)arg5 presenceAuth:(id)arg6 metricsDispatcherFactory:(id)arg7 currentUserFactory:(id /* block */)arg8 residentDeviceManagerFactory:(id /* block */)arg9;
...
- (void)reportToDomain:(id)arg1 identifier:(id)arg2;
