...
@property (setter=_setAllowsAutoScrollingToSelectedTone:, nonatomic) bool _allowsAutoScrollingToSelectedTone;
@property (setter=_setOverrideFirstToneSectionTitle:, nonatomic, copy) NSString *_overrideFirstToneSectionTitle;
...
- (id)_musicPlayer;
- (id)_overrideFirstToneSectionTitle;
- (id)_pickerRowItemForIndexPath:(id)arg1;
- (void)_playMediaItemWithIdentifier:(id)arg1;
- (void)_reloadData;
- (void)_resetScrollingPosition;
- (void)_setAllowsAutoScrollingToSelectedTone:(bool)arg1;
- (void)_setOverrideFirstToneSectionTitle:(id)arg1;
