...
- (id)initWithKeyName:(id)arg1 identifier:(id)arg2 localIdentifier:(id)arg3 pairedEntityIdentifier:(id)arg4 invitationIdentifier:(id)arg5 trackingReceipt:(id)arg6 revocationAttestation:(id)arg7 trackingRequest:(id)arg8 onlineImmoToken:(bool)arg9 supportedTransports:(id)arg10;
