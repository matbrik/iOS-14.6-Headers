...
- (void)map;
- (void)mapLogicalBoundsWithXRanges:(const struct ODIHRangeVector { struct ODIHRange {} *x1; struct ODIHRange {} *x2; struct __compressed_pair<ODIHRange *, ChAllocator<ODIHRange>> { struct ODIHRange {} *x_3_1_1; } x3; }*)arg1;
