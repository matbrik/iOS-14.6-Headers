...
@interface HMServiceGroup : NSObject <HFFavoritable, HFHomeKitObject, HFHomeStatusVisible, HFReorderableHomeKitObject, HFServiceNameComponentsProviding, HFStateDumpBuildable, HFUIRepresentableHomeObject, HFUserNotificationServiceSettingsProviding, HMFLogging, HMFMessageReceiver, HMMutableApplicationData, HMObjectMerge, NSSecureCoding> {
