...
@interface PKPassGroupsViewController : UIViewController <PKAccountServiceAccountResolutionControllerDelegate, PKDiscoveryArticleViewControllerPresenter, PKDiscoveryDataSourceDelegate, PKForegroundActiveArbiterObserver, PKGroupsControllerDelegate, PKInboxDataSourceDelegate, PKPGSVFooterViewDelegate, PKPGSVSectionHeaderViewDelegate, PKPGSVSectionSubheaderDelegate, PKPassGroupStackViewDatasource, PKPassGroupStackViewDelegate, PKPassPersonalizationViewControllerDelegate, PKPaymentServiceDelegate, PKPaymentSetupDelegate, PKPeerPaymentAccountResolutionControllerDelegate, PKPerformActionViewControllerDelegate, PKSubcredentialProvisioningFlowControllerDelegate, UIScrollViewDelegate, _PKUIKVisibilityBackdropViewDelegate> {
...
- (void)_setupItemForExpressUpgradeMarket:(id)arg1 hideDisableAction:(unsigned long long)arg2 completionHandler:(id /* block */)arg3;
...
- (void)presentExpressUpgradeDetailForPassUniqueID:(id)arg1 marketIdentifier:(id)arg2 hideDisableAction:(unsigned long long)arg3 animated:(bool)arg4 completionHandler:(id /* block */)arg5;
