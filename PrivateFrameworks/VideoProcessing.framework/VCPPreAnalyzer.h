...
- (int)_performAnalysis:(id*)arg1 isPano:(bool)arg2 isSDOF:(bool)arg3 forAsset:(id)arg4 withRequestHandler:(id)arg5 andLumaPixelBuffer:(struct __CVBuffer { }*)arg6;
...
- (void)analyzeWithImageURL:(id)arg1 isPano:(bool)arg2 isSDOF:(bool)arg3 forAsset:(id)arg4 completionHandler:(id /* block */)arg5;
