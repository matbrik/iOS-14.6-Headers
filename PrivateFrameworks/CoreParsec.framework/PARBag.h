...
@property (nonatomic, readonly) bool allowSafariRankingDataCollection;
...
@property (nonatomic, readonly) bool exp;
...
@property (nonatomic, readonly) double safariDwellTimeThresholdHigh;
@property (nonatomic, readonly) double safariDwellTimeThresholdMedium;
...
@property (nonatomic, readonly) NSArray *sampleClientTimingEventWhitelist;
...
@property (nonatomic, readonly) NSDictionary *smartSearchV2Parameters;
...
@property (nonatomic, readonly) NSURL *uncommittedSearchURL;
