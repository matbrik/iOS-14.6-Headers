...
- (void)runTransactionWithModel:(id)arg1 options:(id)arg2 completion:(id /* block */)arg3;
- (void)runTransactionWithModels:(id)arg1 completion:(id /* block */)arg2;
- (void)runTransactionWithModels:(id)arg1 options:(id)arg2 completion:(id /* block */)arg3;
