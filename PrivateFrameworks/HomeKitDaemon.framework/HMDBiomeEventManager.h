...
@property (readonly) id /* block */ streamPrunerFactory;
...
- (id)init;
- (id)initWithNotificationCenter:(id)arg1 actionSetStream:(id)arg2 mediaAccessoryStream:(id)arg3 accessoryStream:(id)arg4 streamPrunerFactory:(id /* block */)arg5 workQueue:(id)arg6;
- (id)mediaAccessoryStream;
- (id)notificationCenter;
- (id /* block */)streamPrunerFactory;
