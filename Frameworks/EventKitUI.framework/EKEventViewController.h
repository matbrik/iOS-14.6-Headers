...
@interface EKEventViewController : UIViewController <EKEventDetailNotesCellDelegate, EKEventTitleDetailItemDelegate, EKUIEventStatusButtonsViewDelegate, EKUIManagedViewController, UIAlertViewDelegate, UIScrollViewDelegate, UITableViewDataSource, UITableViewDelegate> {
    bool  _ICSPreview;
...
@property (nonatomic, retain) EKUIInviteesViewMessageSendingManager *messageSendingManager;
...
- (id)previewActionsWithPresentationController:(id)arg1 actionBlock:(id /* block */)arg2;
- (int)scrollToSection;
