...
@interface NSString : NSObject <AADataType, AFSecurityDigestibleChunksProviding, APPCSupplementalContextAllowedTypes, ASDNotificationType, ASParsingLeafNode, ATXScoreLogSerializable, CKLParsedObject, CKRecordValue, CKShortDescription, CKVDatabaseValue, CLSGraphVertex, CMSCoding, CNKeyDescriptor_Private, CNUIURLDestinationID, CRCoding, CRDataType, CREquatable, CSCoderEncoder, CUByteCodable, ECEmailAddressConvertible, EFSQLBindable, EFSQLValueExpressable, FCKeyValueStoreCoding, HAP2AccessoryCharacteristicEncodableBodyValue, HFPropertyListConvertible, HFStringGenerator, HMBQueryableModelFieldCoder, IMJSONSerializableValueProviding, INCodableAttributeRelationComparing, INJSONSerializable, ISCompositorResource, MAPropertyTypeProtocol, MPArtworkDataSourceVisualIdenticality, MPCPlaybackEngineEventPayloadJSONValue, MTMaterialSettingsPropertyIdentityValueProviding, NSCopying, NSItemProviderReading, NSItemProviderWriting, NSMutableCopying, NSSecureCoding, PQLValuable, REContentEncodable, REDonatedActionIdentifierProviding, REMDAChangedIdentifierResult, SASerializable, SBFFileCacheFileIdentifier, SiriCoreSQLiteValue, TLIdentifiable, UIItemProviderReading, UIItemProviderWriting, VCControlChannelMessageProtocol, WFJSONObject, WFJavaScriptCoreBridgeableObject, WFNaming, WFPropertyListObject, WFSlotTemplateContent, WFVariableStringContent, _DKDeduping, _PASDistilledString>
...
@property (nonatomic, readonly) NSData *safari_base64DecodedData;
@property (nonatomic, readonly) bool safari_containsInteriorWhitespace;
@property (nonatomic, readonly) bool safari_containsPeriodOrHomoglyphForPeriod;
@property (nonatomic, readonly, copy) NSString *safari_domainFromHost;
@property (nonatomic, readonly, copy) NSString *safari_filenameByFixingIllegalCharacters;
...
@property (nonatomic, readonly, copy) NSString *safari_simplifiedSiteNameForCredentialLookup;
@property (nonatomic, readonly, copy) NSString *safari_simplifiedUserVisibleURLString;
@property (nonatomic, readonly, copy) NSString *safari_stringByNormalizingVersionString;
@property (nonatomic, readonly, copy) NSString *safari_stringByRedactingBookmarkDAVServerID;
...
@property (nonatomic, readonly, copy) NSString *safari_stringByRemovingWwwAndWildcardDotPrefixes;
@property (nonatomic, readonly, copy) NSString *safari_stringByRemovingWwwDotPrefix;
@property (nonatomic, readonly, copy) NSString *safari_stringByReplacingHomoglyphForSpaceWithSpace;
@property (nonatomic, readonly, copy) NSString *safari_stringByTrimmingWhitespace;
...
@property (nonatomic, readonly) bool tswp_NSDetectorMatchStringIsStrictPhoneNumber;
...
@property (nonatomic, readonly) NSURL *wb_bestURLForUserTypedString;
...
- (bool)_safari_hasLocalizedPrefix:(id)arg1 withOptions:(unsigned long long)arg2;
...
- (bool)safari_hasLocalizedCaseAndDiacriticInsensitivePrefix:(id)arg1;
...
- (struct _NSRange { unsigned long long x1; unsigned long long x2; })safari_rangeOfURLScheme;
...
- (bool)tswp_NSDetectorMatchStringIsStrictPhoneNumber;
