...
@interface QSSRecognitionPhraseTokens : NSObject <FLTBFBufferAccessor, NSCopying> {
    NSData * _data;
    const struct RecognitionPhraseTokens { unsigned char x1[1]; } * _root;
