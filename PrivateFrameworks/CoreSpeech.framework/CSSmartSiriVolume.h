...
@interface CSSmartSiriVolume : NSObject <CSAudioServerCrashMonitorDelegate, CSAudioStreamProvidingDelegate, CSMediaPlayingMonitorDelegate, CSSiriClientBehaviorMonitorDelegate, CSSiriEnabledMonitorDelegate, CSSmartSiriVolumeProcessor> {
