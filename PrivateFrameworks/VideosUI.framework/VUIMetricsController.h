...
@interface VUIMetricsController : NSObject {
    ...
    NSString * _savedOpenUrlForPageEvent;
...
@property (nonatomic, retain) NSString *savedOpenUrlForPageEvent;
...
- (void)setSavedOpenUrlForPageEvent:(id)arg1;
