...
@interface CSXPCClient : NSObject <CSAcousticSLResultProviding, CSAudioAlertProviding, CSAudioMeterProviding, CSAudioMetricProviding, CSAudioSessionInfoProviding, CSAudioSessionProviding, CSAudioStreamProviding, CSAudioTimeConversionProviding, CSFallbackAudioSessionReleaseProviding, CSTriggerInfoProviding> {
    NSString * _UUID;
