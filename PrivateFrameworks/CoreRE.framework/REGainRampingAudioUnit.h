...
@interface REGainRampingAudioUnit : AUAudioUnit {
    ...
    struct unique_ptr<re::audio::FixedSpscAudioQueue<GainRampCommand>, std::__1::default_delete<re::audio::FixedSpscAudioQueue<GainRampCommand>>> { 
        struct __compressed_pair<re::audio::FixedSpscAudioQueue<GainRampCommand> *, std::__1::default_delete<re::audio::FixedSpscAudioQueue<GainRampCommand>>> { 
            struct FixedSpscAudioQueue<GainRampCommand> {} *__value_; 
        } __ptr_; 
    }  _rampGainQueue;
