...
- (long long)_migrateLegacyItem:(id)arg1 dailyVisitCounts:(struct Vector<int, 0, WTF::CrashOnOverflow, 16, WTF::FastMalloc> { int *x1; unsigned int x2; unsigned int x3; }*)arg2 weeklyVisitCounts:(struct Vector<int, 0, WTF::CrashOnOverflow, 16, WTF::FastMalloc> { int *x1; unsigned int x2; unsigned int x3; }*)arg3;
