...
@property (nonatomic) int audioQualityPreference;
@property (nonatomic, retain) NSMutableArray *buildFeatures;
...
@property (nonatomic, retain) ICPAPlayActivityEnqueuerProperties *enqueuerProperties;
...
@property (nonatomic) bool hasAudioQualityPreference;
...
@property (nonatomic) bool hasPlaybackFormatPreference;
...
@property (nonatomic, retain) ICPAPlayModeDictionary *playMode;
@property (nonatomic) int playbackFormatPreference;
@property (nonatomic, retain) NSString *playlistVersionHash;
@property (nonatomic) bool privateListeningEnabled;
@property (nonatomic, retain) ICPAAudioQualityDictionary *providedAudioQuality;
...
@property (nonatomic, retain) ICPAAudioQualityDictionary *targetedAudioQuality;
