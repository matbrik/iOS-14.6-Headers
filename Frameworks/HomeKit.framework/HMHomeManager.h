...
@interface HMHomeManager : NSObject <HFStateDumpBuildable, HMApplicationData, HMCoreAnalyticsMetricEventDispatcherFactory, HMFLogging, HMFMessageReceiver, HMFTimerDelegate, HMMutableApplicationData> {
...
- (void)_addAndSetupAccessoriesWithSetupPayload:(id)arg1 completionHandler:(id /* block */)arg2;
...
- (void)_finishAddAccessoryRequest:(id)arg1 withSetupCompletedInfo:(id)arg2 error:(id)arg3 completionHandler:(id /* block */)arg4;
...
- (void)_pingDeviceWithDestination:(id)arg1 monitor:(bool)arg2 secure:(bool)arg3 completionHandler:(id /* block */)arg4;
- (void)_pingDeviceWithUUID:(id)arg1 monitor:(bool)arg2 secure:(bool)arg3 completionHandler:(id /* block */)arg4;
...
- (void)finishAddAccessoryRequest:(id)arg1 withSetupCompletedInfo:(id)arg2 error:(id)arg3 completionHandler:(id /* block */)arg4;
...
- (void)launchHomeUIServiceWithSetupAccessoryDescription:(id)arg1 completionHandler:(id /* block */)arg2;
...
- (void)notifyClientsOfAssistantIdentifierChange;
