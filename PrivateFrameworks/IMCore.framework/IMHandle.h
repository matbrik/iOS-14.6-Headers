...
@property (nonatomic, readonly, retain) NSString *phoneticFirstName;
@property (nonatomic, readonly, retain) NSString *phoneticFullName;
@property (nonatomic, readonly, retain) NSString *phoneticLastName;
...
+ (void)bestHandlesForCNContacts:(id)arg1 completion:(id /* block */)arg2;
+ (void)bestHandlesForCNContacts:(id)arg1 useExtendedAsyncLookup:(bool)arg2 completion:(id /* block */)arg3;
...
+ (void)handlesForCNContacts:(id)arg1 useBestHandle:(bool)arg2 useExtendedAsyncLookup:(bool)arg3 completion:(id /* block */)arg4;
+ (id)imageManager;
+ (id)nameOfStatus:(unsigned long long)arg1;
+ (bool)notificationsEnabled;
+ (void)setNotificationsEnabled:(bool)arg1;
+ (bool)supportsSecureCoding;
+ (void)validHandlesForCNContacts:(id)arg1 completion:(id /* block */)arg2;
+ (void)validHandlesForCNContacts:(id)arg1 useExtendedAsyncLookup:(bool)arg2 completion:(id /* block */)arg3;
