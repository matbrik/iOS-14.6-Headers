...
@property (readonly) unsigned long long ipAccessoryReachabilityChangedCount;
...
- (void)presentRadarDialog:(id)arg1 limitPostInterval:(bool)arg2;
...
- (void)reviewCloudSyncThresholdBytes:(unsigned long long)arg1 remoteMessageThresholdCount:(unsigned long long)arg2 limitPostInterval:(bool)arg3;
