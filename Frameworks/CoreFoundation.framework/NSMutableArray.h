...
- (void)addDelegate:(id)arg1 withDelegateQueue:(id)arg2 performOnDispatchQueue:(id)arg3 withBlock:(id /* block */)arg4;
- (void)executeBlock:(id /* block */)arg1;
- (void)removeDelegate:(id)arg1 performOnDispatchQueue:(id)arg2 withBlock:(id /* block */)arg3;
...
+ (id)tsch_instanceWithArchive:(const struct ChartsNSArrayOfNSNumberDoubleArchive { int (**x1)(); struct InternalMetadata { void *x_2_1_1; } x2; struct RepeatedField<double> { int x_3_1_1; int x_3_1_2; void *x_3_1_3; } x3; struct CachedSize { struct atomic<int> { struct __cxx_atomic_impl<int, std::__1::__cxx_atomic_base_impl<int>> { _Atomic int x_1_3_1; } x_1_2_1; } x_4_1_1; } x4; }*)arg1 unarchiver:(id)arg2;

- (id)tsch_initWithArchive:(const struct ChartsNSArrayOfNSNumberDoubleArchive { int (**x1)(); struct InternalMetadata { void *x_2_1_1; } x2; struct RepeatedField<double> { int x_3_1_1; int x_3_1_2; void *x_3_1_3; } x3; struct CachedSize { struct atomic<int> { struct __cxx_atomic_impl<int, std::__1::__cxx_atomic_base_impl<int>> { _Atomic int x_1_3_1; } x_1_2_1; } x_4_1_1; } x4; }*)arg1 unarchiver:(id)arg2;
- (void)tsch_saveToArchive:(struct ChartsNSArrayOfNSNumberDoubleArchive { int (**x1)(); struct InternalMetadata { void *x_2_1_1; } x2; struct RepeatedField<double> { int x_3_1_1; int x_3_1_2; void *x_3_1_3; } x3; struct CachedSize { struct atomic<int> { struct __cxx_atomic_impl<int, std::__1::__cxx_atomic_base_impl<int>> { _Atomic int x_1_3_1; } x_1_2_1; } x_4_1_1; } x4; }*)arg1 archiver:(id)arg2;
