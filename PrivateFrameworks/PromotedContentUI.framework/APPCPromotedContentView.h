...
@interface APPCPromotedContentView : UIView <APWebProcessDelegate, NewsTransparencyViewControllerDelegate, SFSafariViewControllerDelegate, WKNavigationDelegate> {
