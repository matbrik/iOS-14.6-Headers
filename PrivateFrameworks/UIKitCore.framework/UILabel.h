...
@interface UILabel : UIView <ABText, MPUAutoupdatingTextContainer, NCTextSupporting, NSCoding, NUCrossFadeViewAnimatable, UIContentSizeCategoryAdjusting, _UILabelVisualStyleSubject, _UIMultilineTextContentSizing, _UIViewBaselineSpacing> {
