...
@property (nonatomic, readonly) double nc_effectiveLineHeight;
...
+ (unsigned int)JFX_symbolicTraitsFromName:(id)arg1;
+ (id)JFX_systemFontDesignFromName:(id)arg1;
+ (double)JFX_systemFontWeightFromName:(id)arg1;
