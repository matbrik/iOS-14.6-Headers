...
- (bool)canRender;
- (id)colorSpace;
- (struct HGRef<HGNode> { struct HGNode {} *x1; })conformInputImage:(id)arg1 colorSpace:(id)arg2 renderer:(const struct HGRef<HGRenderer> { struct HGRenderer {} *x1; }*)arg3 currentTime:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg4 igContext:(struct HGRef<PVInstructionGraphContext> { struct PVInstructionGraphContext {} *x1; })arg5;
