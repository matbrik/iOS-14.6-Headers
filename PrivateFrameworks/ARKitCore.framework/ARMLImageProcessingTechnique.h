...
@interface ARMLImageProcessingTechnique : ARImageBasedTechnique <ARTechniqueBusyState> {
    ...
    struct vector<__CVPixelBufferPool *, std::__1::allocator<__CVPixelBufferPool *>> { 
        struct __CVPixelBufferPool {} **__begin_; 
        struct __CVPixelBufferPool {} **__end_; 
        struct __compressed_pair<__CVPixelBufferPool **, std::__1::allocator<__CVPixelBufferPool *>> { 
