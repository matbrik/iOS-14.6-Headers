...
@interface WebAVPlayerController : NSObject {
    ...
    struct PlaybackSessionModel { int (**x1)(); struct WeakPtrFactory<WebCore::PlaybackSessionModel, WTF::EmptyCounter> { struct RefPtr<WTF::WeakPtrImpl<WTF::EmptyCounter>, WTF::RawPtrTraits<WTF::WeakPtrImpl<WTF::EmptyCounter>>, WTF::DefaultRefDerefTraits<WTF::WeakPtrImpl<WTF::EmptyCounter>>> { struct WeakPtrImpl<WTF::EmptyCounter> {} *x_1_2_1; } x_2_1_1; } x2; } * _delegate;
...
@property /* Warning: unhandled struct encoding: '{PlaybackSessionModel=^^?{WeakPtrFactory<WebCore::PlaybackSessionModel' */ struct *delegate; /* unknown property attribute:  WTF::DefaultRefDerefTraits<WTF::WeakPtrImpl<WTF::EmptyCounter>>>=^{WeakPtrImpl<WTF::EmptyCounter>}}}} */
...
- (void)dealloc;
- (struct PlaybackSessionModel { int (**x1)(); struct WeakPtrFactory<WebCore::PlaybackSessionModel, WTF::EmptyCounter> { struct RefPtr<WTF::WeakPtrImpl<WTF::EmptyCounter>, WTF::RawPtrTraits<WTF::WeakPtrImpl<WTF::EmptyCounter>>, WTF::DefaultRefDerefTraits<WTF::WeakPtrImpl<WTF::EmptyCounter>>> { struct WeakPtrImpl<WTF::EmptyCounter> {} *x_1_2_1; } x_2_1_1; } x2; }*)delegate;
...
- (void)setDelegate:(struct PlaybackSessionModel { int (**x1)(); struct WeakPtrFactory<WebCore::PlaybackSessionModel, WTF::EmptyCounter> { struct RefPtr<WTF::WeakPtrImpl<WTF::EmptyCounter>, WTF::RawPtrTraits<WTF::WeakPtrImpl<WTF::EmptyCounter>>, WTF::DefaultRefDerefTraits<WTF::WeakPtrImpl<WTF::EmptyCounter>>> { struct WeakPtrImpl<WTF::EmptyCounter> {} *x_1_2_1; } x_2_1_1; } x2; }*)arg1;
