...
@interface SNDetectionResult : NSObject <NSCopying, NSSecureCoding, SNConfidenceProviding, SNConfidenceProvidingWritable, SNResult, SNTimeRangeProviding, SNTimeRangeProvidingWritable, SRSampling> {
    double  _confidence;
    bool  _detected;
