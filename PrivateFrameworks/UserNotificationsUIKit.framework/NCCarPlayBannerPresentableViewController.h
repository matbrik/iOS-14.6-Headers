...
@interface NCCarPlayBannerPresentableViewController : UIViewController <BNPresentable, BNPresentableObservable, BNPresentableUniquelyIdentifying, NCCarPlayBannerContentViewDelegate> {
