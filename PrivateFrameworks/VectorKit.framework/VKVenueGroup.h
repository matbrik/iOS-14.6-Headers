...
- (id)initWithStyleQuery:(struct shared_ptr<gss::StylesheetQuery<gss::PropertyID>> { struct StylesheetQuery<gss::PropertyID> {} *x1; struct __shared_weak_count {} *x2; }*)arg1 tileZoom:(float)arg2 layer:(int)arg3 buildingId:(unsigned long long)arg4 contentScale:(float)arg5;
- (int)layer;
...
- (void)updateTextures:(unsigned char)arg1 textureManager:(struct shared_ptr<md::TextureManager> { }*)arg2;
