...
@interface PRItemLocalizer : NSObject <PRDevicePoseProviderDelegate, PRGenericRangingSessionDelegate> {
    ...
    struct BatchSolution { 
        ...
        struct vector<RoseSyntheticApertureFiltering::BatchSolutionParticle, std::__1::allocator<RoseSyntheticApertureFiltering::BatchSolutionParticle>> { 
            struct BatchSolutionParticle {} *__begin_; 
            struct BatchSolutionParticle {} *__end_; 
            struct __compressed_pair<RoseSyntheticApertureFiltering::BatchSolutionParticle *, std::__1::allocator<RoseSyntheticApertureFiltering::BatchSolutionParticle>> { 
...
@property (nonatomic) /* Warning: unhandled struct encoding: '{BatchSolution=iBiB{vector<RoseSyntheticApertureFiltering::BatchSolutionParticle' */ struct  lastSolution; /* unknown property attribute:  std::__1::allocator<RoseSyntheticApertureFiltering::BatchSolutionParticle>>=^{BatchSolutionParticle}}}d} */
...
- (void)reset;
- (void)revokeRangeOrAoATargetEstimate:(struct BatchSolution { int x1; bool x2; int x3; bool x4; struct vector<RoseSyntheticApertureFiltering::BatchSolutionParticle, std::__1::allocator<RoseSyntheticApertureFiltering::BatchSolutionParticle>> { struct BatchSolutionParticle {} *x_5_1_1; struct BatchSolutionParticle {} *x_5_1_2; struct __compressed_pair<RoseSyntheticApertureFiltering::BatchSolutionParticle *, std::__1::allocator<RoseSyntheticApertureFiltering::BatchSolutionParticle>> { struct BatchSolutionParticle {} *x_3_2_1; } x_5_1_3; } x5; double x6; })arg1;
