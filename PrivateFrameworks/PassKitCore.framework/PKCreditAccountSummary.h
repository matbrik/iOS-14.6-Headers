...
@property (nonatomic, copy) NSSet *accountUserActivity;
...
@property (nonatomic, retain) PKCreditAccountMergeSummary *mergeSummary;
...
- (id)rewardsBalance;
- (void)setAccountUserActivity:(id)arg1;
