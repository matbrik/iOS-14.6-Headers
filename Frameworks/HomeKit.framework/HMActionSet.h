...
@interface HMActionSet : NSObject <HFFavoritable, HFHomeKitObject, HFReorderableHomeKitObject, HFStateDumpBuildable, HMFMessageReceiver, HMMutableApplicationData, HMObjectMerge, NSSecureCoding> {
...
- (bool)_addActionFromResponse:(id)arg1 withAction:(id)arg2 completion:(id /* block */)arg3;
- (bool)_doAddAction:(id)arg1 uuid:(id)arg2 completionHandler:(id /* block */)arg3;
