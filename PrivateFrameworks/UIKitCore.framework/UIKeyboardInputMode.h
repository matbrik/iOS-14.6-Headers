...
- (id)_iconLabel;
- (id)_indicatorIconWithBackground:(bool)arg1;
...
- (id)displayName;
- (void)drawStringInRect:(id)arg1 inRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg2 useCondensedFont:(bool)arg3;
...
- (id)imageForInputModeLabel:(id)arg1 secondaryIconLabel:(id)arg2 withBackground:(bool)arg3;
