...
@interface TUIEmojiSearchInputViewController : UIInputViewController <TUIEmojiSearchResultsCollectionViewControllerDelegate, TUIEmojiSearchSourceDelegate, TUIEmojiSearchTextFieldDelegate, UIPredictiveViewController> {
