...
- (void)startVoicePreviewForLanguageCode:(id)arg1 gender:(long long)arg2 reply:(id /* block */)arg3;
- (void)startVoicePreviewForLanguageCode:(id)arg1 voiceName:(id)arg2 previewType:(long long)arg3 reply:(id /* block */)arg4;
