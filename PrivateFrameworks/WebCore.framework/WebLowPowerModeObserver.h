...
@interface WebLowPowerModeObserver : NSObject {
    ...
    struct LowPowerModeNotifier { struct RetainPtr<WebLowPowerModeObserver> { void *x_1_1_1; } x1; struct Function<void (bool)>={unique_ptr<WTF::Detail::CallableWrapperBase<void, bool>, std::__1::default_delete<WTF::Detail::CallableWrapperBase<void, bool>>>={__compressed_pair<WTF::Detail::CallableWrapperBase<void, bool> *, std::__1::default_delete<WTF::Detail::CallableWrapperBase<void, bool>>>=^{CallableWrapperBase<void, bool> {} x2; } * _notifier;
}

@property (nonatomic, readonly) bool isLowPowerModeEnabled;
@property (nonatomic) struct LowPowerModeNotifier { struct RetainPtr<WebLowPowerModeObserver> { void *x_1_1_1; } x1; /* Warning: unhandled struct encoding: '{Function<void (bool)>={unique_ptr<WTF::Detail::CallableWrapperBase<void' */ struct x2; }*notifier; /* unknown property attribute:  bool>}}}}} */

- (void)_didReceiveLowPowerModeChange;
- (void)dealloc;
- (id)initWithNotifier:(struct LowPowerModeNotifier { struct RetainPtr<WebLowPowerModeObserver> { void *x_1_1_1; } x1; struct Function<void (bool)>={unique_ptr<WTF::Detail::CallableWrapperBase<void, bool>, std::__1::default_delete<WTF::Detail::CallableWrapperBase<void, bool>>>={__compressed_pair<WTF::Detail::CallableWrapperBase<void, bool> *, std::__1::default_delete<WTF::Detail::CallableWrapperBase<void, bool>>>=^{CallableWrapperBase<void, bool> {} x2; }*)arg1;
- (bool)isLowPowerModeEnabled;
- (struct LowPowerModeNotifier { struct RetainPtr<WebLowPowerModeObserver> { void *x_1_1_1; } x1; struct Function<void (bool)>={unique_ptr<WTF::Detail::CallableWrapperBase<void, bool>, std::__1::default_delete<WTF::Detail::CallableWrapperBase<void, bool>>>={__compressed_pair<WTF::Detail::CallableWrapperBase<void, bool> *, std::__1::default_delete<WTF::Detail::CallableWrapperBase<void, bool>>>=^{CallableWrapperBase<void, bool> {} x2; }*)notifier;
