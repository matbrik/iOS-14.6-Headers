...
+ (void)convertVImageGeoMaps:(struct vImage_Buffer {}**)arg1 toVector:(struct vector<std::__1::vector<float, std::__1::allocator<float>>, std::__1::allocator<std::__1::vector<float, std::__1::allocator<float>>>> { struct vector<float, std::__1::allocator<float>> {} *x1; struct vector<float, std::__1::allocator<float>> {} *x2; struct __compressed_pair<std::__1::vector<float, std::__1::allocator<float>> *, std::__1::allocator<std::__1::vector<float, std::__1::allocator<float>>>> { struct vector<float, std::__1::allocator<float>> {} *x_3_1_1; } x3; }*)arg2;
...
+ (id)genPolyResults:(struct vImage_Buffer { void *x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; }*)arg1 geoMap:(struct vImage_Buffer {}**)arg2 targetSize:(struct CGSize { double x1; double x2; })arg3 scale:(struct CGSize { double x1; double x2; })arg4 mergingType:(int)arg5;
