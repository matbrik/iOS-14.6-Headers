...
@interface FCCloudContext : NSObject <FCAssetKeyManagerDelegate, FCBundleSubscriptionChangeObserver, FCCKDatabaseEncryptionDelegate, FCCacheFlushing, FCContentContext, FCPrivateDataContext, FCTestingContext> {
    ...
    <FCFavoritesPersonalizer> * _favoritesPersonalizer;
    FCFeedManager * _feedManager;
    <FCPersonalizedGrouping> * _groupingPersonalizer;
...
@property (nonatomic, retain) <FCFavoritesPersonalizer> *favoritesPersonalizer;
...
@property (nonatomic, retain) <FCPersonalizedGrouping> *groupingPersonalizer;
...
- (void)setFavoritesPersonalizer:(id)arg1;
- (void)setGroupingPersonalizer:(id)arg1;
