...
@interface CSCoverSheetViewController : UIViewController <BCBatteryDeviceObserving, BSDescriptionProviding, CAAnimationDelegate, CSAccessoryStatusDelegate, CSCoverSheetViewControllerProtocol, CSCoverSheetViewDelegate, CSCoverSheetViewTransitionSource, CSDateTimeLayoutAggregating, CSEmbeddedContentActionManagerDelegate, CSFaceOcclusionMonitorDelegate, CSInterstitialTransitionDelegate, CSLegibilityProviderDelegate, CSMainPageContentViewControllerNotificationObserver, CSNotificationClearingTriggerDelegate, CSNotificationDestination, CSPasscodeViewControllerDelegate, CSPersistentContentLayoutProviding, CSPresentationViewControllerDelegate, CSProudLockViewControllerDelegate, CSRemoteContentSessionHostDelegate, CSScrollGestureControllerDelegate, CSTimerViewControllerDelegate, FBSDisplayLayoutPublisherObserving, SBCoverSheetSlidingViewControllerContentViewController, SBFDashBoardModalPresenterProtocol, SBFIrisWallpaperViewDelegate, SBFOverlayDismissalDelegate, SBFOverlayObserving, SBLockScreenActionProvider, SBUIPhoneUnlockWithWatchControllerDelegate, SFAutoUnlockManagerDelegate, UIGestureRecognizerDelegate, _UISettingsKeyObserver> {
...
- (void)_setComponentsHiddenForLandscape:(bool)arg1;
...
- (void)faceOcclusionMonitorDidDetectBottomFaceOccluded:(id)arg1;
- (id)fakeStatusBar;
