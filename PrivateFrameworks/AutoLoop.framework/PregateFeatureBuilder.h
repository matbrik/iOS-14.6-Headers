...
- (id)facesArray;
- (id)featuresDict;
- (int)fillVector:(struct vector<float, std::__1::allocator<float>> { float *x1; float *x2; struct __compressed_pair<float *, std::__1::allocator<float>> { float *x_3_1_1; } x3; }*)arg1 withPerFrameStats:(id)arg2;
