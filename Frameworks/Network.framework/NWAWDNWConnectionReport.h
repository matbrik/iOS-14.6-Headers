...
@interface NWAWDNWConnectionReport : PBCodable <NSCopying> {
    ...
    struct { 
        ...
        unsigned int connectionReportReason : 1; 
        ...
        unsigned int transformConnectedProtocolIndex : 1; 
        unsigned int transformLastTimeoutMsecs : 1; 
        ...
        unsigned int transformConnectedProtocol : 1; 
        unsigned int transformFirstProtocol : 1; 
        ...
        unsigned int isProbe : 1; 
        unsigned int multipathConfigured : 1; 
        unsigned int prohibitsConstrained : 1; 
        unsigned int prohibitsExpensive : 1; 
        unsigned int quicAlternativePresent : 1; 
        unsigned int quicApplicationDeferred : 1; 
        unsigned int quicDeferred : 1; 
        unsigned int quicDenied : 1; 
        unsigned int quicExperimentEnabled : 1; 
        unsigned int quicUpdatedAlternative : 1; 
        unsigned int resolutionRequired : 1; 
        unsigned int svcbDoHURI : 1; 
        unsigned int svcbReceived : 1; 
        unsigned int svcbRequested : 1; 
    ...
    bool  _quicAlternativePresent;
    bool  _quicApplicationDeferred;
    bool  _quicDeferred;
    bool  _quicDenied;
    bool  _quicExperimentEnabled;
    bool  _quicUpdatedAlternative;
    ...
    int  _transformConnectedProtocol;
    unsigned long long  _transformConnectedProtocolIndex;
    int  _transformFirstProtocol;
    unsigned long long  _transformLastTimeoutMsecs;
...
@property (nonatomic, retain) NSMutableArray *protocolEstablishmentReports;
...
- (int)StringAsTransformConnectedProtocol:(id)arg1;
- (int)StringAsTransformFirstProtocol:(id)arg1;
...
- (void)setHasQuicAlternativePresent:(bool)arg1;
- (void)setHasQuicApplicationDeferred:(bool)arg1;
- (void)setHasQuicDeferred:(bool)arg1;
- (void)setHasQuicDenied:(bool)arg1;
- (void)setHasQuicExperimentEnabled:(bool)arg1;
- (void)setHasQuicUpdatedAlternative:(bool)arg1;
...
- (void)setHasTransformConnectedProtocol:(bool)arg1;
- (void)setHasTransformConnectedProtocolIndex:(bool)arg1;
- (void)setHasTransformFirstProtocol:(bool)arg1;
- (void)setHasTransformLastTimeoutMsecs:(bool)arg1;
...
- (void)setProtocolEstablishmentReports:(id)arg1;
- (void)setProxyMilliseconds:(unsigned long long)arg1;
- (void)setQuicAlternativePresent:(bool)arg1;
- (void)setQuicApplicationDeferred:(bool)arg1;
- (void)setQuicDeferred:(bool)arg1;
- (void)setQuicDenied:(bool)arg1;
- (void)setQuicExperimentEnabled:(bool)arg1;
- (void)setQuicUpdatedAlternative:(bool)arg1;
...
- (void)setTransformConnectedProtocol:(int)arg1;
- (void)setTransformConnectedProtocolIndex:(unsigned long long)arg1;
- (void)setTransformFirstProtocol:(int)arg1;
- (void)setTransformLastTimeoutMsecs:(unsigned long long)arg1;
...
- (id)transformConnectedProtocolAsString:(int)arg1;
- (unsigned long long)transformConnectedProtocolIndex;
- (int)transformFirstProtocol;
- (id)transformFirstProtocolAsString:(int)arg1;
