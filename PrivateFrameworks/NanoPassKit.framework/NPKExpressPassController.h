...
- (void)_handleCarKeyVehicleEngineStartedNotification:(id)arg1;
...
- (void)_onqueue_transactionCompletedForPassiveEntryEvent:(unsigned long long)arg1 withApplicationIdentifier:(id)arg2 applicationKeyIdentifier:(id)arg3;
...
- (void)_parseRKEActionNotificationObject:(id)arg1 outApplicationIdentifier:(id*)arg2 outApplicationKeyIdentifier:(id*)arg3;
...
- (void)_transitionToPassiveEntryEvent:(unsigned long long)arg1 forExpressPass:(id)arg2;
