...
@interface _CDMailIntelligencePETDataCollectionTask : NSObject <HMHomeManagerDelegate> {
    ...
    long long  _mailIntelligenceUserId;
    double  _samplingRate;
    bool  _selectedForDataCollection;
    _CDMailIntelligencePETDataCollectionSession * _session;
...
@property (nonatomic, readonly) SGMailIntelligenceStringHasher *hasher;
@property (nonatomic, retain) HKHealthStore *healthStore;
@property (nonatomic, retain) _CDInteractionStore *interactionStore;
@property (nonatomic, readonly) long long mailIntelligenceUserId;
@property (nonatomic, readonly) double samplingRate;
@property (nonatomic) bool selectedForDataCollection;
@property (nonatomic, retain) _CDMailIntelligencePETDataCollectionSession *session;
...
- (id)contactIdDictUsingStore:(id)arg1 contact:(id)arg2;
...
- (id)initWithStorage:(id)arg1 contactStore:(id)arg2 healthStore:(id)arg3 activity:(id)arg4 sessionPath:(id)arg5 dataDirectory:(id)arg6 collectionDate:(id)arg7 samplingRate:(double)arg8;
- (id)interactionStore;
- (id)labelMembers;
- (long long)mailIntelligenceUserId;
