...
@interface SBBannerManager : NSObject <BNBannerSourceListenerDelegate, BNPosting, BNPostingPrivate, BNPresentingDelegate, SBAssistantObserver, SBBannerManagerHomeGestureContextDelegate, SBButtonEventsHandler> {
...
- (id)bannerSourceListener:(id)arg1 newBannerSourceListenerPresentableForBannerSpecification:(id)arg2 scene:(id)arg3 readyCompletion:(id /* block */)arg4;
