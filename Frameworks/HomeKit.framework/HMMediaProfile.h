...
@interface HMMediaProfile : HMAccessoryProfile <HFMediaProfileContainer, HFServiceNameComponentsProviding, HFUIRepresentableHomeObject, HMAccessorySettingsContainer, HMMediaObject, HMSleepWakeStateProvider, _HMMediaProfileDelegate> {
