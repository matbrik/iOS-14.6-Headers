...
- (void)_postReaderSessionBurnoutTimerInvokedWithType:(unsigned int)arg1 uuid:(id)arg2 startTime:(id)arg3 params:(id)arg4;
- (void)_postReaderSessionEndedWithType:(unsigned int)arg1 uuid:(id)arg2 startTime:(id)arg3 params:(id)arg4;
- (void)_postReaderSessionPollingStartedWithType:(unsigned int)arg1 uuid:(id)arg2 startTime:(id)arg3 params:(id)arg4;
...
- (void)postAWDReaderModeExceptionForType:(unsigned int)arg1 tagType:(unsigned int)arg2 rfFrameInterface:(bool)arg3 withErrorCode:(unsigned int)arg4;
