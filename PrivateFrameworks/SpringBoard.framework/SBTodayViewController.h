...
@interface SBTodayViewController : UIViewController <CSExternalBehaviorProviding, PTSettingsKeyObserver, SBFIdleTimerBehaviorProviding, SBFOverlayObserving, SBHLegibility, SBHOccludable, SBHTodayViewController, SBIconListLayoutObserver, SBIconListModelObserver, SBIconListViewDragDelegate, SBIconLocationPresenting, SBIconViewObserver, SBIconViewQuerying, SBTodayViewSpotlightPresenterDelegate, SBUICoronaAnimationControllerParticipant, SBUISpotlightInitiating, UIGestureRecognizerDelegate, UIScrollViewDelegate, WGMajorListViewControllerDelegate, WGWidgetIconAnimationExtraViewsProviding> {
...
- (double)lastRootSideBarContentOffset;
...
- (void)setLastRootSideBarContentOffset:(double)arg1;
