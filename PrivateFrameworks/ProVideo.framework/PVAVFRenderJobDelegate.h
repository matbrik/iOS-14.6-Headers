...
@interface PVAVFRenderJobDelegate : NSObject <PVRenderJobDelegate> {
    ...
    struct HGCVGLTextureFactory { int (**x1)(); struct atomic<unsigned int> { struct __cxx_atomic_impl<unsigned int, std::__1::__cxx_atomic_base_impl<unsigned int>> { _Atomic unsigned int x_1_2_1; } x_2_1_1; } x2; struct HGRef<HGGLContext> { struct HGGLContext {} *x_3_1_1; } x3; struct __CVOpenGLESTextureCache {} *x4; } * m_hgCVGLTextureFactory;
