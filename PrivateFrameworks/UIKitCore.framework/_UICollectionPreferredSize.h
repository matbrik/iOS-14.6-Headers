...
- (id)initWithOriginalSize:(struct CGSize { double x1; double x2; })arg1 fittingSize:(struct CGSize { double x1; double x2; })arg2 layoutSize:(id)arg3 additionalData:(id)arg4;
- (id)layoutSize;
