...
@interface LPiTunesMediaSongMetadata : LPSpecializationMetadata <LPLinkMetadataBackwardCompatibility, LPLinkMetadataPresentationTransformer, LPLinkMetadataPreviewTransformer, LPLinkMetadataStatusTransformer, LPLinkMetadataStoreTransformer> {
    NSString * _album;
    NSString * _artist;
    LPImage * _artwork;
