...
@property (nonatomic, readonly) struct NSDirectionalEdgeInsets { double x1; double x2; double x3; double x4; } environmentInsets;
...
- (struct NSDirectionalEdgeInsets { double x1; double x2; double x3; double x4; })environmentInsets;
- (double)groupDimension;
- (id)initWithOrthogonalLayoutAxis:(unsigned long long)arg1 layoutAxis:(unsigned long long)arg2 pagingDimension:(double)arg3 groupDimension:(double)arg4 layoutFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg5 contentSize:(struct CGSize { double x1; double x2; })arg6 contentInsets:(struct NSDirectionalEdgeInsets { double x1; double x2; double x3; double x4; })arg7 environmentInsets:(struct NSDirectionalEdgeInsets { double x1; double x2; double x3; double x4; })arg8 orthogonalContentOffset:(struct CGPoint { double x1; double x2; })arg9;
