...
- (id)initWithFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 monogrammerStyle:(long long)arg2 shouldAllowTakePhotoAction:(bool)arg3 threeDTouchEnabled:(bool)arg4 contactStore:(id)arg5 allowsImageDrops:(bool)arg6 imageRenderer:(id)arg7;
