...
@property (nonatomic) unsigned long long recordingSourceType;
...
- (bool)_hasMultipleVoiceTriggerInfoAvailable:(id)arg1;
...
- (id)initWithAudioStreamHandleId:(unsigned long long)arg1 audioRecorder:(id)arg2 withCSRecordSourceType:(unsigned long long)arg3 withDeviceId:(id)arg4;
- (bool)isNarrowBand;
- (bool)isRecording;
