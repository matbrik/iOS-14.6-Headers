...
@property (nonatomic, retain) NSArray *zoomFactors;
...
+ (id)_createMaskImageWithSize:(struct CGSize { double x1; double x2; })arg1 tickLabelCenterRadialInset:(double)arg2 notchMaskImage:(id)arg3 labelMaskImage:(id)arg4;
