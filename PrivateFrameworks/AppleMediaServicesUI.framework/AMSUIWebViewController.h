...
@interface AMSUIWebViewController : AMSUICommonViewController <AMSBagConsumer, AMSUIWebActionRunnerDelegate, AMSUIWebPageViewControllerDelegate, AMSUIWebProtocolDelegate, AMSURLProtocolDelegate, NSURLSessionDelegate> {
