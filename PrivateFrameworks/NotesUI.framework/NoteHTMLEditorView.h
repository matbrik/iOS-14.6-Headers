...
@interface NoteHTMLEditorView : UIView <UIScrollViewDelegate, WKNavigationDelegate, WKScriptMessageHandler, WKUIDelegatePrivate, WKURLSchemeHandler, _WKInputDelegate> {
