...
+ (struct CGSize { double x1; double x2; })estimatedMediaContentSizeWithScreenshots:(id)arg1 trailers:(id)arg2 fitting:(struct CGSize { double x1; double x2; })arg3 in:(id)arg4;
