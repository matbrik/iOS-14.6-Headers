...
@interface FCFeedPersonalizedItemScoreProfile : NSObject {
    ...
    double  _lowFlowMultiplier;
    NSDictionary * _lowFlowScores;
...
@property (nonatomic) double lowFlowMultiplier;
@property (nonatomic, retain) NSDictionary *lowFlowScores;
...
- (void)setLowFlowMultiplier:(double)arg1;
- (void)setLowFlowScores:(id)arg1;
