...
@interface CSSpeechManager : NSObject <CSActivationEventNotificationHandlerDelegate, CSAudioProviderDelegate, CSAudioRecorderDelegate, CSAudioServerCrashMonitorDelegate, CSOpportuneSpeakEventMonitorDelegate, CSVoiceTriggerAssetHandlerDelegate> {
    ...
    CSVoiceTriggerEventsCoordinator * _voiceTriggerEventNotifier;
...
@property (nonatomic, retain) CSAcousticSLProxy *acousticSL;
...
@property (nonatomic, retain) CSVoiceTriggerEventsCoordinator *voiceTriggerEventNotifier;
...
- (void)_setupSpeakerRecognitionWithCompletion:(id /* block */)arg1;
