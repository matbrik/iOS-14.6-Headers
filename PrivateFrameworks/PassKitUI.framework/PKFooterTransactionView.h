...
@interface PKFooterTransactionView : UIView <PKContactResolverDelegate> {
    ...
    PKPaymentPass * _pass;
    PKContactResolver * _peerPaymentContactResolver;
...
@property (nonatomic, readonly) PKContactResolver *peerPaymentContactResolver;
...
@property (nonatomic, readonly, copy) NSArray *transitCommutePlans;
