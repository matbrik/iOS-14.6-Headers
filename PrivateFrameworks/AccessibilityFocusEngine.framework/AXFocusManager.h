...
- (void)_moveFocusWithHeading:(unsigned long long)arg1 byGroup:(bool)arg2 queryString:(id)arg3;
...
- (bool)_recursiveMoveFocusInApplication:(id)arg1 withHeading:(unsigned long long)arg2 byGroup:(bool)arg3;
