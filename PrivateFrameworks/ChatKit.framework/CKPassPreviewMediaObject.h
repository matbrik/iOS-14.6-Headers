...
+ (id)_colorFromDictionaryRepresentation:(id)arg1;
+ (id)_darkenColor:(id)arg1;
+ (id)_dictionaryRepresentationForColorString:(id)arg1;
+ (id)_dictionaryRepresentationForText:(id)arg1 colorString:(id)arg2;
+ (id)_paddedImage:(id)arg1;
