...
@interface SBFolderView : UIView <BSDescriptionProviding, SBFolderObserver, SBIconListLayoutDelegate, SBIconListPageControlDelegate, SBIconListViewDragDelegate, SBIconScrollViewDelegate, UITextFieldDelegate> {
...
- (bool)isScrolling;
- (bool)isVisibleColumnRangeValid:(struct SBVisibleColumnRange { unsigned long long x1; struct _NSRange { unsigned long long x_2_1_1; unsigned long long x_2_1_2; } x2; })arg1;
- (id)lastIconListView;
