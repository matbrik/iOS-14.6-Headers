...
@property (nonatomic, retain) NSMutableArray *pendingDiscoveredAccessoryCharacteriticReads;
...
- (bool)isComplete;
- (id)pendingDiscoveredAccessoryCharacteriticReads;
...
- (void)setPendingDiscoveredAccessoryCharacteriticReads:(id)arg1;
