...
@property (nonatomic) /* Warning: unhandled struct encoding: '{VideoFullscreenInterfaceAVKit=^^?^^?{atomic<unsigned int>={__cxx_atomic_impl<unsigned int' */ struct *fullscreenInterface; /* unknown property attribute:  WTF::DefaultRefDerefTraits<WTF::StringImpl>>=^{StringImpl}}}BBBBBBBBBBBBBBBBBBBBBBBBBBBB} */
