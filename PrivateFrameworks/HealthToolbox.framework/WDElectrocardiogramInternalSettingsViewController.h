...
@interface WDElectrocardiogramInternalSettingsViewController : HKTableViewController <HKHeartRhythmAvailabilityObserver, HRElectrocardiogramOnboardingManagerDelegate, UIPickerViewDataSource, UIPickerViewDelegate> {
