...
@interface SFFormAutocompleteState : NSObject <CNContactPickerDelegate, SFAppAutoFillOneTimeCodeProviderObserver, SFContactAutoFillViewControllerFiller, _ASCredentialListViewControllerDelegate, _ASPasswordCredentialAuthenticationViewControllerDelegate, _SFCreditCardCaptureViewControllerDelegate> {
