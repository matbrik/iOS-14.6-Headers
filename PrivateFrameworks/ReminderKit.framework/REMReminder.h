...
@interface REMReminder : NSObject <REMDAChangeTrackableFetchableModel, REMDAChangedModelObjectResult, REMExternalSyncMetadataProviding, REMObjectIDProviding, _REMDAChangeTrackableModel> {
    REMAccount * _account;
    REMList * _list;
